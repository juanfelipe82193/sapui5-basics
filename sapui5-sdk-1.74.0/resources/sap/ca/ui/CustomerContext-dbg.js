 ...
 */
sap.ui.core.Control.extend("sap.ca.ui.CustomerContext", /** @lends sap.ca.ui.CustomerContext.prototype */ { metadata : {
 ...
 *
 * @name sap.ca.ui.CustomerContext#setModel
 * @function
 * @type void
 * @public
 ...
 *
 * @name sap.ca.ui.CustomerContext#select
 * @function
 * @type void
 * @public
 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
 ...
 *
 * @name sap.ca.ui.CustomerContext#change
 * @function
 * @type void
 * @public
 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
 ...
 *
 * @name sap.ca.ui.CustomerContext#reset
 * @function
 * @type void
 * @public
 * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
...
jQuery.sap.require("sap.ca.ui.CustomerControlListItem");

// opening modes
sap.ca.ui.CustomerContext.MODE = {Select: 'Select', Change: 'Change'};
...
sap.ca.ui.CustomerContext.prototype.init = function () {
		...
		press: jQuery.proxy(function () {
			if (this._oList.getSelectedItem()) {
				...
				if (this._oPersService) {
					...
					jQuery.sap.log.warning("CustomerContext: there is no service defined for saving the SelectedCustomer, did you set the personalizationPageName property? ");
				}
	...
	// CSS: 0120031469 0000378557 2014
	this._bindListItems(this.getPath());

	//------------- binds the list and the dialog together ------------------------------
	page.addContent(this._oList);
	this._oDialog.addContent(page);
	...
	this._oDialog.setInitialFocus(this._oButtonCancel);
};
...
sap.ca.ui.CustomerContext.prototype.setModel = function (oModel) {
	...
	/* static list + live search only: transforms the model into a local JSON model */
	...
	// CSS: 0120031469 0000701294 2014
	this._bindListItems(this.getPath());
};
...
/**
 * @returns {sap.ca.ui.CustomerControlListItem} A custom list item with the customer's info
 * @private
 */
sap.ca.ui.CustomerContext.prototype._getItemTemplate = function () {
	var oCCLI = new sap.ca.ui.CustomerControlListItem({
		showSalesArea: this.getShowSalesArea(),
		customerID: { path: this.getCustomerIDProperty() },
		customerName: { path: this.getCustomerNameProperty() },
		salesOrganizationName: { path: this.getSalesOrganizationNameProperty() },
		distributionChannelName: { path: this.getDistributionChannelNameProperty() },
		divisionName: { path: this.getDivisionNameProperty() }
	});
	return oCCLI;
};
...
sap.ca.ui.CustomerContext.prototype._bindListItems = function (sPath) {
