...
sap.ca.ui.DatePickerRenderer.writeInnerContent = function (oRm, oControl) {
    oRm.write('<div class="sapMInputValHelp sapCaUi5Workaround_sapMInputBaseDynamicContent">');
    oRm.renderControl(oControl._getCalendarIcon());
    oRm.write('</div>');
};
