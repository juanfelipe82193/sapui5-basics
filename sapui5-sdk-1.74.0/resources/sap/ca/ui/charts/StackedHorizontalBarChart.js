 ...
 */
jQuery.sap.declare("sap.ca.ui.charts.StackedHorizontalBarChart");jQuery.sap.require("sap.ca.ui.library");jQuery.sap.require("sap.ca.ui.charts.Chart");sap.ca.ui.charts.Chart.extend("sap.ca.ui.charts.StackedHorizontalBarChart",{metadata:{deprecated:true,library:"sap.ca.ui",properties:{type:{type:"string",group:"Designtime",defaultValue:'StackedBar',deprecated:true},minTouchSize:{type:"sap.ui.core.CSSSize",group:"Dimension",defaultValue:'48px',deprecated:true},dataLabelFormat:{type:"any",group:"Appearance",defaultValue:[["##"]]}},aggregations:{content:{type:"sap.ui.core.Control",multiple:true,singularName:"content",deprecated:true}}}});jQuery.sap.require("sap.ca.ui.charts.ChartType");
