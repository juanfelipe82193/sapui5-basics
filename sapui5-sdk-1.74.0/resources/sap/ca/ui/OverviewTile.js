 ...
 */
jQuery.sap.declare("sap.ca.ui.OverviewTile");jQuery.sap.require("sap.ca.ui.library");jQuery.sap.require("sap.m.Tile");sap.m.Tile.extend("sap.ca.ui.OverviewTile",{metadata:{deprecated:true,library:"sap.ca.ui",properties:{title:{type:"string",group:"Misc",defaultValue:'null'},icon:{type:"sap.ui.core.URI",group:"Misc",defaultValue:'null'},contact:{type:"string",group:"Misc",defaultValue:'null'},address:{type:"string",group:"Misc",defaultValue:'null'},opportunities:{type:"string",group:"Misc",defaultValue:'null'},rating:{type:"string",group:"Misc",defaultValue:'null'},lastContact:{type:"string",group:"Misc",defaultValue:'null'},nextContact:{type:"string",group:"Misc",defaultValue:'null'},revenue:{type:"string",group:"Misc",defaultValue:'null'},visible:{type:"boolean",group:"Misc",defaultValue:true},width:{type:"sap.ui.core.CSSSize",group:"Dimension",defaultValue:null},contactActive:{type:"boolean",group:"Behavior",defaultValue:false}},events:{contactPress:{}}}});jQuery.sap.require("sap.ui.core.IconPool");jQuery.sap.require("sap.ca.ui.utils.resourcebundle");
