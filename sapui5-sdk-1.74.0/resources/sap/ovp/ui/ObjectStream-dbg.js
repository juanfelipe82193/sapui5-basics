 ...
 */
sap.ui.define(["sap/ui/thirdparty/jquery", "sap/ui/Device", "sap/ui/core/Control", "sap/ui/core/Icon",
    "sap/m/Dialog", "sap/ovp/app/resources", "sap/ui/events/KeyCodes", "sap/base/util/uid"],
    function (jQuery, Device, Control, Icon, Dialog, OvpResources, KeyCodes, uid) {
        "use strict";
        ...
        var ObjectStream = Control.extend("sap.ovp.ui.ObjectStream", { metadata : {
            library : "sap.ovp",
            aggregations : {
        ...
        ObjectStream.prototype.init = function() {
            ...
            this._closeIcon = new Icon({
                ...
                tooltip: OvpResources.getText("close")
            });
        ...
        ObjectStream.prototype._initScrollVariables = function () {
            ...
            this.shouldShowScrollButton = (!Device.system.phone && !Device.system.tablet) || Device.system.combi; //should be shown only in desktop (and combi)
        ...
        ObjectStream.prototype._afterOpen = function () {
            ...
            jQuery("#sap-ui-static").prepend(this.jqBackground);
        ...
        ObjectStream.prototype.setCardsSize = function(cardWidth) {
            ...
            var cardHeight = Device.system.phone ? document.body.clientHeight / remSize - 4.5 : 28.75;
