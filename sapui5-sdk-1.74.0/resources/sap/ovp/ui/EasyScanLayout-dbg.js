sap.ui.define(["sap/ui/thirdparty/jquery", "sap/ovp/cards/CommonUtils", "sap/ovp/ui/UIActions",
    "sap/ui/Device", "sap/ui/core/Control", "sap/ui/core/ResizeHandler", "sap/ovp/app/resources", "sap/ovp/app/OVPUtils", "sap/ui/events/F6Navigation", "sap/ui/events/KeyCodes"],
    function (jQuery, CommonUtils, UIActions, Device, Control, ResizeHandler, OvpResources, OVPUtils, F6Navigation, KeyCodes) {
        "use strict";
        ...
        ReplaceItems.prototype.initCardsSettingsForDragAndDrop = function () {
            ...
            if (Device.system.tablet === true && Device.system.desktop === false) {
        ...
        */
        ...
        KeyboardNavigation.prototype.keyupHandler = function(e) {
          ...
          if (this.swapSourceElement != null && e.keyCode === this.keyCodes.CONTROL) {
            ...
            this.endSwap();
          } else if (e.keyCode === this.keyCodes.SPACE) {
        ...
        var EasyScanLayout = Control.extend("sap.ovp.ui.EasyScanLayout", {
        ...
        EasyScanLayout.prototype.init = function () {
            ...
            var matchMediaSupported = Device.browser.msie && Device.browser.version > 9;
        ...
        EasyScanLayout.prototype.headerMargin = function (that) {
            ...
            jQuery('.sapFDynamicPageHeader').css({"margin-left": margin + "rem", "margin-right": margin + "rem"});
            ...
            if (Device.system.desktop) {
                ...
                if (screenWidth === contentWidth) {
                    ...
                    jQuery('.sapFDynamicPageHeader').css({"margin-left": marginLeft + "rem", "margin-right": marginRight + "rem"});
                }
            }
        };
        ...
        EasyScanLayout.prototype.setActive = function (bSetActive) {
            if (bSetActive) {
        ...
        EasyScanLayout.prototype.getActive = function () {
