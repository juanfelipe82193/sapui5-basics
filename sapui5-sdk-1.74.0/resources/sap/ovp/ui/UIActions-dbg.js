sap.ui.define(["sap/ui/thirdparty/jquery", "sap/ui/base/Object", "sap/ui/events/KeyCodes"],
    function (jQuery, BaseObject, KeyCodes) {
        "use strict";

        return BaseObject.extend("sap.ovp.ui.UIActions", {
            constructor: function (cfg) {
                    ...
                    if (eventObj) {
                        ...
                        if (this.element) {
                            ...
                            if (this.layoutDetails) {
                                var rightX = this.isRTLEnabled ? (this.startX - elemLeft) < this.resizeHandleDistance : (elemLeft + elemWidth - this.startX) < this.resizeHandleDistance;
                ...
                this.endHandler = function (evt) {
                    this.log('endHandler');
                    if ((evt.type == this.keyUpEvent && evt.which == KeyCodes.ESCAPE) || evt.type == this.mouseUpEvent || evt.type == this.touchEndEvent) {
                        this.captureEnd(evt);
                        switch (this.mode) {
                            case 'normal':
                                this.log('-> normal');
