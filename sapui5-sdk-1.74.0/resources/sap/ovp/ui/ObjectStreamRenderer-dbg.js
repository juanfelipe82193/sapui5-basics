sap.ui.define(["sap/ui/core/Icon"],
    function(Icon) {
        "use strict";
        ...
        ObjectStreamRenderer.render = function(oRm, oControl) {
            ...
            oRm.renderControl(new Icon({src: "sap-icon://slim-arrow-left", useIconTooltip:false}));
            oRm.write('</div>');
            oRm.write('<div id="' + oControl.getId() + '-rightedge" class="sapOvpOSEdgeRight">');
            oRm.renderControl(new Icon({src: "sap-icon://slim-arrow-right", useIconTooltip:false}));
            oRm.write('</div>');
