 ...
 */
sap.ui.define(["sap/ui/thirdparty/jquery", "sap/base/Log"], function (jQuery, Log) {
    "use strict";
     ...
     *
     * @returns {sap.ovp.support.lib.CommonMethods.mApplicationStatus} application status
     */
     ...
     *
     * @param {string} sStatus application status
     * @see sap.ovp.support.lib.CommonMethods.mApplicationStatus
     */
    ...
    function fnPublishEvent(sChannel, sEvent, oData) {
        Log.info("Global event '" + sEvent + "' published on channel '" + sChannel + "'");
