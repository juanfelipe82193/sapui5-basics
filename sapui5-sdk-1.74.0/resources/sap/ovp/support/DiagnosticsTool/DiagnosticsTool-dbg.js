sap.ui.define([
    ...
    "sap/ovp/support/lib/CommonChecks",
    "sap/ovp/support/lib/CommonMethods"
], function (jQuery, Plugin, DateFormat, JSONModel, CommonChecks, CommonMethods) {
    "use strict";
    ...
    function getMethods(oSupportStub) {
        ...
        function fnGetView(sId) {
            ...
            if (oView) {
                ...
                return sap.ui.xmlview(sId, {
                    viewName: "sap.ovp.support.DiagnosticsTool.view.DiagnosticsTool",
                    viewData: {
                        plugin: oPlugin
                    }
                });
        ...
        function fnTriggerSetData() {
            ...
            oSupportStub.sendEvent(sPluginId + "SetData", JSON.parse(oModel.getJSON()));
        }
     ...
     */
    return Plugin.extend("sap.ovp.support.DiagnosticsTool.DiagnosticsTool", {
        constructor: function (oSupportStub) {
            Plugin.apply(this, [sPluginId, "SAP Fiori Elements", oSupportStub]);
            jQuery.extend(this, getMethods(oSupportStub));
        }
    });
});
