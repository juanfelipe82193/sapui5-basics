...
//voca rules
	...
	exposedObject.CP_VALUE_SOURCE = "ValueSources";
	exposedObject.CP_VALUE_ENUM = "Enumerations";
	exposedObject.CP_VOCABULARY_ID = "VocabularyId";
	exposedObject.CP_DATOBJECT_ID = "DataObjectId";
	exposedObject.CP_ATTRIBUTE_ID = "AttributeId";
	exposedObject.CP_VALUE_SOURCE_TYPE = "SourceType";
	exposedObject.CP_VALUE_SOURCE_TYPE_STATIC = "U";
	exposedObject.CP_VALUE_SOURCE_TYPE_SERVICE = "O";
	exposedObject.CP_HAS_VALUE_SOURCE = "HasValueSource";
