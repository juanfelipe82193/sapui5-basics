...
sap.rules.ui.parser.resources.vocabulary.lib.constants.lib = (function() {
	...
	var consts = {
		...
		//Dataobject Type
		PROPERTY_DATA_OBJECT_TYPE_STRUCTURE: "structure",
		PROPERTY_DATA_OBJECT_TYPE_TABLE: "table",
		PROPERTY_DATA_OBJECT_TYPE_ELEMENT: "Element",
		...
		BUSINESS_DATA_TYPE_GEOMETRY: 'Geometry',
