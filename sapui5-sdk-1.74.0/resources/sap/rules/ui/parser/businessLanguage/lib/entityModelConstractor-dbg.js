...
sap.rules.ui.parser.businessLanguage.lib.entityModelConstractor.lib = (function() {
	...
	function NavigationPredicateDetails(args) { // args : {navigationPredicate, attribute, rootObject, associationsArray}
		try {
			...
			utilsLib.addProperties(this, args, ["navigationPredicate", "navigationFullPath", "navigationFullPathId", "attribute", "attributeId", "attributeType", "rootObject", "rootObjectId", "associationsArray", "attributeMappingType", "attributeValueList", "isVocaRule", "isParameter", "isCollection", "isAlias", "isDataObject", "dataObject", "modifiers"], [null, null, null, null, null, null, null, null, null, null, null, false, false, false, false, null, null, null]);
           ...
           */
			...
			this.getString = function() {
				...
				var attributeId = this.getAttributeId();
