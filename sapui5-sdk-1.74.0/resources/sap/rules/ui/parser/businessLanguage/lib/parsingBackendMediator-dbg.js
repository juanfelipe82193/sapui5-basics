...
sap.rules.ui.parser.businessLanguage.lib.parsingBackendMediator.lib = (function() {
	...
	parsingBackendMediatorLib.prototype.parseExpression = function(expression, mode, vocaRTServ, paramServ, type, vocabulary, flags, valueListAttribute) {
		...
		try {
			...
			switch (mode) {
				...
				case constantsLib.AUTOCOMPLETE_MODE_LOWERCASE:
					...
					*/
					responseObject.suggs = JSON.parse(autoCompleteUtilsLib.getNextSuggestions(expression, lexer, parser, vocaRTServ, type, valueListAttribute));
