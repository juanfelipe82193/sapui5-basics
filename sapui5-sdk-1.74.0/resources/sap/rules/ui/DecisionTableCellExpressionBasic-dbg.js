    ...
    var DecisionTableCellExpressionBasic = ExpressionBasic.extend("sap.rules.ui.DecisionTableCellExpressionBasic", {
        metadata: {
            ...
            properties: {
                ...
                /**
                 * Defines the attribute Name value of the control.
                 */
                attributeName: {
                    type: "string",
                    defaultValue: "",
        ...
        _reload: function() {
            this._isOperation = " is ";
            this._ofOperation = " of the ";
            this._equalOperation = "is equal to";
            var attributeName;
            var resultDataObjectName = this.resultDataObjectName;
            if ("getAttributeName" in this && this.getAttributeName()) {
                attributeName = this.getAttributeName();
            }
            //Creating the header value for the Basic mode to be rendered for Results.
            if (attributeName && resultDataObjectName) {
                if (this.getType() === "Boolean") {
                    this.sHeaderValue = resultDataObjectName + this._isOperation + attributeName;
                } else {
                    this.sHeaderValue = attributeName + this._ofOperation + resultDataObjectName;
                }
                this.FixedOperatorValue = this._equalOperation ;
            } else {
            ...
            if (!this.sHeaderValue && !this.FixedOperatorValue) {
                ...
                if (this.sHeaderValue && this.FixedOperatorValue) {
                    ...
                    if (!expressionLanguage._hasValueSource && this._checkForValueHelpSuggestions(suggestions)) {
                        return;
                    }
