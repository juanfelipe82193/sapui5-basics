...
sap.ui.define([
	...
	"sap/rules/ui/Constants"
],	function(jQuery, library, Utils, ExpressionAdvanced, Constants) {
		"use strict";
		...
		DecisionTableCellExpressionAdvanced.prototype.getFormattingTokens = function (oExpressionLanguage) {
					...
					// If the cell is of result section - set a header and fixed operator
					if (oExpressionLanguage._hasValueSource && sHeader === "" && sFixOperator === "") {
						this.attributeId = this.mProperties.attributeInfo;
						this.valueListAttrInfo = oExpressionLanguage.getValueListAttribute(this.attributeId);
						if (this.valueListAttrInfo) {
							sHeader = this.valueListAttrInfo.navPath;
							sFixOperator = Constants.IS_EQUAL_TO;
						}
					}
