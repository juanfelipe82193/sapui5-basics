...
sap.ui.define([
	...
	function(Core, library1, Log, ObjectPath, jQuery, CssPlugin)	{
	"use strict";
	...
	// still load require.js synchronously so that it is loaded only __after__ d3.js
	sap.ui.requireSync("sap/ui/thirdparty/require");
	...
	sap.viz._applyTheme = function() {
		...
		// Reset color mapping
		sap.ui.requireSync("sap/ui/core/theming/Parameters");
		var mapping = {};
	...
	sap.viz._applyLocale = function(callback) {
		...
		Log.info("VIZ: env initialized (locale=" + sap.ui.getCore().getConfiguration().getLanguage() + ")");
	};
