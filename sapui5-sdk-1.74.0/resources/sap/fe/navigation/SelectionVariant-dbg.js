 ...
 */
sap.ui.define(
	["./NavError", "sap/ui/base/Object", "sap/ui/thirdparty/jquery", "sap/base/Log"],
	function(Error, BaseObject, jQuery, Log) {
		"use strict";
		 ...
		 */
		var SelectionVariant = BaseObject.extend(
			...
			/** @lends sap.fe.navigation.SelectionVariant */
			{
				...
				_parseFromStringParameters: function(aParameters) {
					jQuery.each(
						aParameters,
						jQuery.proxy(function(iIdx, oEntry) {
				...
				_parseFromStringSelectOptions: function(aSelectOptions) {
					jQuery.each(
						aSelectOptions,
						jQuery.proxy(function(iIdx, oSelectOption) {
							...
							jQuery.each(
								...
								jQuery.proxy(function(iIdx2, oRange) {
