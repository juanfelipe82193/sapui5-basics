...
sap.ui.define([
	...
	shims["sap/ui/vk/ve/thirdparty/html2canvas"] = {
		exports: "html2canvas",
		amd: true
	};
	shims["sap/ui/vk/threejs/thirdparty/totara"] = {
		exports: "Totara",
		amd: true
	};
	...
	shims["sap/ui/vk/thirdparty/GlMatrixUtils"] = {
		exports: "GlMatrixUtils",
		amd: true
	};
	 ...
	 * @return {sap.ui.vk.AnimationPlayback} Animationlaybacks or <code>undefined</code>.
	 * @private
	 */
	 ...
	 * @function
	 * @param {any} 	 [joint]                      Joint to retrieve. If omited, all joints will be retrieved
	 * @param {any?}     jointData.parent             parent node. If omited, all joints for the specified child will be retrieved
	 * @param {any?}     jointData.node               child node. If omited, all joints for the specified parent will be returned.
	 *
	 ...
	 * @function
	 * @param {any} [jointData]               joint data. If omited, all joints will be removed.
	...
	///////////////////////////////////////////////////////////////////
	 ...
	 //
	 // properties:
	 //		autoPlayAnimation - start playing animation after a view became active
	 //		autoAdvanceView - switch to a next view in the ViewGroup after views's animation have been finished or after timeout
	 //		autoAdvanceViewTimeout - timeout before automatic advancing to a next view
	 //
	 //	events:
	 //		viewActivated
	 //
	 ...
	 * Activates a view.
	 *
	 * @name sap.ui.vk.IViewManager.prototype.activateView
	 * @function
	 * @param {sap.ui.vk.View} view               view to activate
	 *
	 * @return {sap.ui.vk.IViewManager} <code>this</code> to allow method chaining.
	 * @private
	 */

	/**
	 * Plays views from the view group sequentially from the current state.
	 *
	 * @name sap.ui.vk.IViewManager.prototype.playViewGroup
	 * @param {sap.ui.vk.View} view                view to start playing from. If it's same as an active view, the animation will resume from the current position.
	...
	/**
	 * Stops playing the current view group.
	 *
	 * @name sap.ui.vk.IViewManager.prototype.stopPlayingViewGroup
	 * @function
	 *
	 * @return {sap.ui.vk.IViewManager} <code>this</code> to allow method chaining.
	 * @private
