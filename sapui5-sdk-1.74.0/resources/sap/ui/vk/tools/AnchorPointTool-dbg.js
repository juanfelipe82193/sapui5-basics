...
sap.ui.define([
	 ...
	 *
	 * @param {any|any[]} target The node reference or the array of node references.
	 ...
	 * @public
	 */
	AnchorPointTool.prototype.alignTo = function(nodeRef) {
		this._deactivateScreenAlignment();
		var quaternion = new THREE.Quaternion();
		if (nodeRef) {
			nodeRef.matrixWorld.decompose(new THREE.Vector3(), quaternion, new THREE.Vector3());
		}
