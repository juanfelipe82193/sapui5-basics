...
sap.ui.define([
	...
	CrossSectionToolGizmo.prototype.show = function(viewport, tool) {
		...
		if (this._firstShowPress){
			var bbox = viewport._scene ? viewport._scene._computeBoundingBox(viewport._getLayers(), true) : new THREE.Box3();
	...
	CrossSectionToolGizmo.prototype._getDelta = function() {
		var bbox = this._viewport._scene._computeBoundingBox(this._viewport._getLayers(), true);
		bbox.getSize(size);
	...
	CrossSectionToolGizmo.prototype.expandBoundingBox = function(boundingBox) {
		if (this._viewport) {
			var sceneBoundingBox = this._viewport._scene._computeBoundingBox(this._viewport._getLayers(), true);
