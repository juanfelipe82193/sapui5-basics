...
sap.ui.define([
	...
	NodeProxy.prototype.assignMaterial = function(value) {
		...
		var setNodeRefMaterial = function(materialRef, nodeRef) {
			...
			if (nodeRef.material !== undefined) {
				...
				if (nodeRef.userData.opacity !== undefined) {
	 ...
	 *
	 * @param {sap.ui.vk.Material} materialToReplace Material to be replaced.
	 * @param {sap.ui.vk.Material} material Material replacement.
	 * @returns {sap.ui.vk.NodeHierarchy} <code>this</code> to allow method chaining.
	 * @public
	 */
