...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'matai-dbg.wast';
  var wasmBinaryFile = 'matai-dbg.wasm';
  var asmjsCodeFile = 'matai-dbg.temp.asm.js';
...
var ASM_CONSTS = [function($0, $1, $2) { console.log('geometry: failed ' + $0 + '-' + $1 + '-' + $2) },
...
// {{PRE_LIBRARY}}
  ...
  function _SceneBuilderAdapter_createMaterial(
  		...
  		var info = {
  			name: UTF8ToString(name),
  			ambient: getArrayF32(ambient, 3),
  			diffuse: getArrayF32(diffuse, 3),
  			specular: getArrayF32(specular, 3),
  			emissive: getArrayF32(emissive, 3),
  			opacity: opacity,
...
Module['wasmTableSize'] = 6329;

Module['wasmMaxTableSize'] = 6329;
...
function invoke_iijfj(index,a1,a2,a3,a4,a5,a6) {
  var sp = stackSave();
  try {
    return Module["dynCall_iijfj"](index,a1,a2,a3,a4,a5,a6);
  } catch(e) {
    stackRestore(sp);
    if (typeof e !== 'number' && e !== 'longjmp') throw e;
    Module["setThrew"](1, 0);
...
function invoke_iijiiiij(index,a1,a2,a3,a4,a5,a6,a7,a8,a9) {
  var sp = stackSave();
  try {
    return Module["dynCall_iijiiiij"](index,a1,a2,a3,a4,a5,a6,a7,a8,a9);
  } catch(e) {
    stackRestore(sp);
    if (typeof e !== 'number' && e !== 'longjmp') throw e;
    Module["setThrew"](1, 0);
...
function invoke_iijjiiij(index,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10) {
  var sp = stackSave();
  try {
    return Module["dynCall_iijjiiij"](index,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10);
  } catch(e) {
    stackRestore(sp);
    if (typeof e !== 'number' && e !== 'longjmp') throw e;
    Module["setThrew"](1, 0);
...
var __GLOBAL__sub_I_GraphSelectorResolver_cpp = Module["__GLOBAL__sub_I_GraphSelectorResolver_cpp"] = function() {  return Module["asm"]["__GLOBAL__sub_I_GraphSelectorResolver_cpp"].apply(null, arguments) };
var __GLOBAL__sub_I_MathConstants_cpp = Module["__GLOBAL__sub_I_MathConstants_cpp"] = function() {  return Module["asm"]["__GLOBAL__sub_I_MathConstants_cpp"].apply(null, arguments) };
...
var __GLOBAL__sub_I_ZIPVFSCompression_cpp = Module["__GLOBAL__sub_I_ZIPVFSCompression_cpp"] = function() {  return Module["asm"]["__GLOBAL__sub_I_ZIPVFSCompression_cpp"].apply(null, arguments) };
...
var _jsMatai_LoadScene = Module["_jsMatai_LoadScene"] = function() {  return Module["asm"]["_jsMatai_LoadScene"].apply(null, arguments) };
...
var dynCall_iiiiijii = Module["dynCall_iiiiijii"] = function() {  return Module["asm"]["dynCall_iiiiijii"].apply(null, arguments) };
...
var dynCall_iijiiiij = Module["dynCall_iijiiiij"] = function() {  return Module["asm"]["dynCall_iijiiiij"].apply(null, arguments) };
var dynCall_iijiij = Module["dynCall_iijiij"] = function() {  return Module["asm"]["dynCall_iijiij"].apply(null, arguments) };
var dynCall_iijij = Module["dynCall_iijij"] = function() {  return Module["asm"]["dynCall_iijij"].apply(null, arguments) };
var dynCall_iijj = Module["dynCall_iijj"] = function() {  return Module["asm"]["dynCall_iijj"].apply(null, arguments) };
...
var dynCall_jiij = Module["dynCall_jiij"] = function() {  return Module["asm"]["dynCall_jiij"].apply(null, arguments) };
...
// {{MODULE_ADDITIONS}}
			...
			/* global Browser, Module, FS, ERRNO_CODES, console, sap */
			...
			function getArrayU8(p, n) {
				var array = new Uint8Array(n);
				for (var i = 0; i < n; i++) {
					array[i] = Module.HEAPU8[p++];
				}
				return array;
			}

			function getArrayU16(p, n) {
				p >>= 1;
				var array = new Uint16Array(n);
				for (var i = 0; i < n; i++) {
					array[i] = Module.HEAPU16[p++];
				}
				return array;
			}

			function getArrayU32(p, n) {
				p >>= 2;
				var array = new Uint32Array(n);
				for (var i = 0; i < n; i++) {
					array[i] = Module.HEAPU32[p++];
				}
				return array;
			}

			function getArrayF32(p, n) {
				p >>= 2;
				var array = new Float32Array(n);
				for (var i = 0; i < n; i++) {
					array[i] = Module.HEAPF32[p++];
				}
				return array;
			}

			function getArrayF64(p, n) {
				p >>= 3;
				var array = new Float64Array(n);
				for (var i = 0; i < n; i++) {
					array[i] = Module.HEAPF64[p++];
				}
				return array;
			}

			var imageFormat = [ "auto", "jpeg", "png", "raw" ];
			var textureType = [ "diffuse", "bump", "opacity", "reflection", "refraction", "specular", "ambient", "emissive", "specularLevel", "glossiness", "ambientOcclusion", "decal" ];

			Module.loadScene = function(sceneBuilder, filename, password, locale) {
				var res = ccall("jsMatai_LoadScene", "number", ["string", "string", "string"], [filename, password, locale, SB.add(sceneBuilder)]);
				return res;
			};

			function createFileFromArrayBuffer(buffer, url, sourceLocation /* can be "local" or "remote" */) {
			...
			Module.loadSceneFromArrayBuffer = function(sceneBuilder, buffer, fileName, password, sourceLocation) {
				fileName = createFileFromArrayBuffer(buffer, fileName, sourceLocation);
				return this.loadScene(sceneBuilder, fileName, password);
			};
		...
		var stepDownMemorySize =  16 * 1024 * 1024; // 16 MB
		...
		while (module === null && options.totalMemory > 0) {
			...
			try {
				...
				if (e.message === "Invalid typed array length" || e.message === "Invalid array buffer length" || e.message === "Out of memory") {
					console.log(e.message + ":" + options.totalMemory);
					options.totalMemory -= stepDownMemorySize;
				} else {
					console.log("ERROR CREATING MATAI");
					console.log(e);
					throw e;
				}
			}
			...
			resolve(
				{
					...
					loadSceneFromArrayBuffer: module.loadSceneFromArrayBuffer
				}
			);
		}
	});
...
///**
// * SAP Visual Enterprise Matai namespace.
// * @namespace sap.ve.matai
// */

/**
 * Creates a Matai module runtime instance.
 * @function sap.ve.matai.createRuntime
 ...
 * @returns {sap.ve.matai~Matai}                           A Matai module runtime instance.
 */

/**
 * Matai module runtime. Instances of this type are not created with operator <code>new</code>.
 * They can only be created with a call to [sap.ve.matai.createRuntime()]{@link sap.ve.matai.createRuntime}.
 * @typedef {Object} sap.ve.matai~Matai
 * @property {sap.ve.matai~loadScene} loadScene A function to load a VDS4 file.
 * @property {sap.ve.matai~loadSceneFromArrayBuffer} loadSceneFromArrayBuffer A function to load a VDS4 file from ArrayBuffer.
 */
