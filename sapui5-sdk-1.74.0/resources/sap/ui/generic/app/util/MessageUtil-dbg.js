...
sap.ui.define([
	...
	function(ValueState, Filter, FilterOperator, JSONModel, MessageToast, syncStyleClass) {
		"use strict";
		...
		function handleTransientMessages(vMessageDialogData, sActionLabel) {
			...
			return new Promise(function(fnResolve){
				...
				oDialog = fnMessageDialogProvider("sap.ui.generic.app.fragments.MessageDialog", oDialogFragmentController);
