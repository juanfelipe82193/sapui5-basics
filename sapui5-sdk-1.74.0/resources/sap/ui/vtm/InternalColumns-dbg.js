...
sap.ui.define([
    ...
    function(
        ...
        InternalColumns.createVisibilityColumn = function() {
            ...
            var checkEye = new sap.ui.vtm.CheckEye({
                visibility: true,
                decorative: false,
                tooltip: {
                    path: "",
                    formatter: function() {
                        return checkEye.visibility ? hideAllString : showAllString;
                    }
                }
            });

            checkEye.addEventDelegate({
                onfocusin: function(event) {
                    checkEye.getDomRef().blur();
                }
            }, checkEye);
        ...
        InternalColumns.createMessageStatusColumn = function () {
            var rb = sap.ui.vtm.getResourceBundle();
            var messageStatusHeaderIcon = new sap.ui.core.Icon({
            ...
            var settings = jQuery.extend(getDefaultSettings(), {
                ...
                labelControl: messageStatusHeaderIcon,
                hAlign: sap.ui.core.HorizontalAlign.Center,
                width: "2.5em",
                resizable: false
            });
