...
sap.ui.define([
	...
	// The next 3 properties are not from VBI JSON
	threeDVisualObjectPrototype.object3D      = undefined;            // type: THREE.Object3D, this property can change if changes in other properties
	...
	threeDVisualObjectPrototype.normalize     = "false";              // type: boolean
	...
	threeDVisualObjectPrototype.selectColor   = "RHLSA(0.7;0.5;0;1)"; // type: color or colorDelta
	threeDVisualObjectPrototype.texture6      = "false";              // type: boolean
	...
	threeDVisualObjectPrototype.dragSource    = undefined;
	threeDVisualObjectPrototype.dropTarget    = undefined;
	*/
	 ...
	 * NB: the properties with the 'undefined' value are declared to be enumerable in for...in loops.
	 */
	var colladaModelPrototype = Object.create(threeDVisualObjectPrototype);
