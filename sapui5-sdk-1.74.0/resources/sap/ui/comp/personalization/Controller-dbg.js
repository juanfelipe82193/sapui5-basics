...
// Provides Controller
sap.ui.define([
	'sap/ui/thirdparty/jquery', 'sap/ui/base/ManagedObject', 'sap/m/library', 'sap/ui/comp/library', './ColumnsController', './FilterController', './GroupController', './SortController', './DimeasureController', './SelectionController', './Util', './ChartWrapper', './SelectionWrapper', './ColumnHelper', 'sap/m/P13nDialog', './Validator', 'sap/ui/model/json/JSONModel', 'sap/ui/Device', 'sap/ui/model/BindingMode'
], function(jQuery, ManagedObject, MLibrary, CompLibrary, ColumnsController, FilterController, GroupController, SortController, DimeasureController, SelectionController, Util, ChartWrapper, SelectionWrapper, ColumnHelper, P13nDialog, Validator, JSONModel, Device, BindingMode) {
	"use strict";
	...
	Controller.prototype.setColumnKeys = function(aColumnKeys) {
		...
		var aColumnKeysValid = aColumnKeys.filter(function(sColumnKey, iIndex) {
			...
			if (bInvalid) {
				jQuery.sap.log.warning("The provided columnKeys is inconsistent as columnKey " + sColumnKey + " is not unique and therefore the duplicate entry is deleted from columnKeys.");
			}
			return !bInvalid;
		});
