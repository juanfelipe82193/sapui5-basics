...
sap.ui.define([
	'sap/ui/comp/library', 'sap/ui/comp/util/DateTimeUtil', 'sap/ui/comp/odata/ODataType', 'sap/ui/comp/util/FormatUtil', 'sap/ui/core/format/DateFormat', "sap/base/Log"
], function(library, DateTimeUtil, ODataType, FormatUtil, DateFormat, Log) {
	"use strict";
		...
		if ((oValue === null) || (oValue === undefined) || (oValue === "")) {
			...
			if ((oFilterMetadata.type === "Edm.DateTime") || (oFilterMetadata.type === "Edm.Time")) {
				if (oFilterBar && oFilterBar.isInUTCMode && oFilterBar.isInUTCMode()) {
					oValue = DateTimeUtil.localToUtc(new Date(oValue)).toJSON();
				}
