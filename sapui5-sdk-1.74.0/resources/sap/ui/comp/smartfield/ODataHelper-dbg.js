...
sap.ui.define([
	...
	ODataHelper.prototype.getAbsolutePropertyPathToValueListEntity = function(oSettings) {
		...
		if ((typeof sBindingContextPath === "string") && (sBindingContextPath !== "")) {
		...
		if (oValueListTextAnnotation && oValueListEntitySet) {
			...
			return "/" + oValueListEntitySet.name + "(" + vValue + ")" + "/" + oValueListTextAnnotation.Path;
		}
	 ...
	 * @since 1.52
	 */
	ODataHelper.prototype.loadValueListAnnotation = function(sPath) {
		var oPromise = this.getAnalyzer().getValueListAnnotationLazy(sPath);
