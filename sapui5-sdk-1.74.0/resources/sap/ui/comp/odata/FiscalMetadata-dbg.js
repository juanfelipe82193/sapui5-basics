...
sap.ui.define([], function() {
	...
	/**
	 * If the property reflects a fiscal annotation and the annotaion is with value <code>true</code> returns its string representation.
	 *
	 * @private
	 * @static
	 * @param {object} oProperty The OData property from the meta model
	...
	updateViewMetadata: function(oViewMetadata) {
		var sAnotationType = this.getFiscalAnotationType(oViewMetadata);
		if ( sAnotationType === "com.sap.vocabularies.Common.v1.IsFiscalYearPeriod" ||
			sAnotationType === "com.sap.vocabularies.Common.v1.IsFiscalYearQuarter" ||
			sAnotationType === "com.sap.vocabularies.Common.v1.IsFiscalYearWeek") {
