...
sap.ui.define([
	...
	'sap/base/Log'
], function(jQuery, library, Element, Factory, JSONModel, MetadataAnalyser, BindingMode, Log) {
	"use strict";
	...
	SemanticObjectController.prototype.registerControl = function(oControl) {
		if (!oControl || !(oControl.isA("sap.ui.comp.navpopover.SmartLink") || oControl.isA("sap.ui.comp.navpopover.NavigationPopoverHandler"))) {
			Log.warning("sap.ui.comp.navpopover.SemanticObjectController: " + (oControl.getMetadata ? oControl.getMetadata() : "parameter") + " is neither of SmartLink nor of NavigationPopoverHandler instance");
			return;
		}
