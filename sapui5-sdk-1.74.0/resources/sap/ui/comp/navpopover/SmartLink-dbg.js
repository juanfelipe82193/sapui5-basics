...
sap.ui.define([
...
], function(ManagedObject, Link, LinkData, Control, SemanticObjectController, NavigationPopoverHandler, JSONModel, PersonalizationUtil, Util, Log) {
	"use strict";
	...
	SmartLink.prototype.getAccessibilityInfo = function() {
		// BCP 1880542324
		return this.getEnabled() ? Link.prototype.getAccessibilityInfo.apply(this, arguments) : {
