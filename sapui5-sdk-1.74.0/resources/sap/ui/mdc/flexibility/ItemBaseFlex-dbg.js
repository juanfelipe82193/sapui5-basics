...
sap.ui.define([
	...
	var ItemBaseFlex = {
		...
		_getExistingAggregationItem: function(oChangeContent, mPropertyBag, oControl) {
			...
			var oControlAggregationItem = oModifier.bySelector(oControlSelector, mPropertyBag.appComponent, mPropertyBag.view);

			if (!oControlAggregationItem && aAggregationItems) {
