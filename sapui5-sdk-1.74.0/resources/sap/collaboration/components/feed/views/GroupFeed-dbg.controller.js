...
sap.ui.define(["jquery.sap.global", "sap/ui/core/mvc/Controller", "sap/suite/ui/commons/TimelineItem", "sap/m/MessageBox",
			   ...
			   "sap/ui/model/json/JSONModel", "sap/m/ToolbarSpacer", "sap/m/Button", "sap/m/library", "sap/ui/core/Fragment",
			   "sap/m/ResponsivePopover", "sap/ui/Device", "sap/ui/core/CustomData", "sap/m/Link", "sap/ui/core/library",
			   "sap/m/List", "sap/m/CustomListItem", "sap/collaboration/library"],
	function(jQuery, Controller, TimelineItem, MessageBox, LanguageBundle, DateUtil, FeedEntryEmbedded, ReplyPopover, SocialTextArea, FilterPopover, CommonUtil, ModeFactory, JSONModel, ToolbarSpacer, Button, mobileLibrary, Fragment, ResponsivePopover, Device, CustomData, Link, coreLibrary, List, CustomListItem, library) {
	"use strict";
