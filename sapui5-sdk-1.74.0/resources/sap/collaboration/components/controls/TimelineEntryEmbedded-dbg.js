...
*/
sap.ui.define(['jquery.sap.global', 'sap/ui/core/Control', 'sap/collaboration/components/utils/LanguageBundle', 'sap/m/Text', 'sap/m/Link', 'sap/m/List', 'sap/m/FeedListItem', 'sap/m/Popover', 'sap/m/library'],
	function(jQuery, Control, LanguageBundle, Text, Link, List, FeedListItem, Popover, mobileLibrary) {
	"use strict";
