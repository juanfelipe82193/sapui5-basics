...
sap.ui.define(['jquery.sap.global', 'sap/ui/model/json/JSONModel',
			   'sap/m/TextArea', 'sap/m/Popover', 'sap/m/List', 'sap/m/StandardListItem',
			   './SuggestionUtility', '../utils/LanguageBundle', 'sap/m/library', 'sap/ui/Device'],
	function(jQuery, JSONModel, TextArea, Popover, List, StandardListItem, SuggestionUtility, LanguageBundle, mobileLibrary, Device) {
	...
	jQuery.sap.includeStyleSheet(jQuery.sap.getResourcePath("sap/collaboration/components/resources/css/SocialTextArea", ".css"));
