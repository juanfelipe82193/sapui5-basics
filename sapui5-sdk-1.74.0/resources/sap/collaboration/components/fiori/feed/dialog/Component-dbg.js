...
sap.ui.define(['sap/collaboration/components/utils/CommonUtil', 'sap/collaboration/components/utils/JamUtil', 'sap/collaboration/components/utils/OdataUtil', 'sap/collaboration/library', 'sap/ui/core/UIComponent', 'jquery.sap.global', 'sap/ui/model/odata/ODataModel', 'sap/ui/core/mvc/View', 'sap/ui/core/library', 'sap/m/Dialog', 'sap/m/Button', 'sap/ui/Device'], function(CommonUtil, JamUtil, OdataUtil, library, UIComponent, jQuery, ODataModel, View, coreLibrary, Dialog, Button, Device) {
	"use strict";
