...
sap.ui.define([
	...
	function(jQuery, library, Control, IconPool, Parameters, Label, Icon, CalendarLegendRenderer) {
	"use strict";
	...
	CalendarLegend.prototype._setLegendLabelByName = function(iName,iValue){
		...
		if (!olabel){ // create label and add to aggregation
			olabel = new Label(this.getId() + '-' + iName,{
				width:"auto"
			});
			...
			// create box label
			oColor = new Label(this.getId() + '-Color' + iName);
	...
	CalendarLegend.prototype._createIcon = function() {
		...
		var oIcon = new Icon(this.getId() + sIconName,{
