...
sap.ui.define(['sap/base/util/Version', 'sap/base/Log'],
	...
	TabContainerRenderer.render = function(oRm, oControl) {
		 ...
		 * should not be used.
		*/
		var useTabContainerCompatVersion = new Version(sap.ui.getCore().getConfiguration().getCompatibilityVersion("sapMeTabContainer"));
		if (useTabContainerCompatVersion.compareTo("1.16") >= 0) {
			Log.error("The sap.me.TabContainer control is not supported as of SAPUI5 version 1.16. Please us sap.m.IconTabBar instead.");
			return;
		}
