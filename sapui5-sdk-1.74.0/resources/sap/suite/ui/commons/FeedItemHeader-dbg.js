...
sap.ui.define([
...
], function (ListItemBase, library, HTML, URLWhitelist, Log, FeedItemHeaderRenderer) {
	"use strict";
	...
	FeedItemHeader.prototype.setImage = function (sImageUri) {
		if (sImageUri) {
			var validUrl = URLWhitelist.validate(sImageUri);
			if (validUrl) {
	...
	FeedItemHeader.prototype.setLink = function (sLinkUri) {
		if (sLinkUri) {
			var validUrl = URLWhitelist.validate(sLinkUri);
			if (validUrl) {
