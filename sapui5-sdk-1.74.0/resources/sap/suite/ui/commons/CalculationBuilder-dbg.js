sap.ui.define([
	...
	"sap/m/library"
			 ...
			 OverflowToolbarToggleButton, OverflowToolbarButton, ToolbarSpacer, Title, Popup, MessageBox, uid, coreLibrary, mLibrary) {
	"use strict";
	...
	var CalculationBuilder = Control.extend("sap.suite.ui.commons.CalculationBuilder", {
		...
		renderer: function (oRm, oCalculationBuilder) {
			...
			if (oCalculationBuilder.getReadOnly()) {
				oRm.addClass("sapCalculationBuilderReadOnly");
			}
			...
			if (bIsInputVisible) {
				...
				oRm.write("<div");
				oRm.addClass("sapCalculationBuilderInputOuterWrapper");
	...
	CalculationBuilder.prototype._isStringConstant = function (sKey) {
	...
	CalculationBuilder.prototype._getType = function (sKey) {
		...
		if (this.getAllowStringConstants() && this._isStringConstant(sKey)) {
