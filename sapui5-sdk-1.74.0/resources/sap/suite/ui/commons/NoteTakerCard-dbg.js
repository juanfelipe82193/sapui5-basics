...
sap.ui.define([
	...
	"./NoteTakerCardRenderer"
			 ...
			 CommonsHorizontalLayout, LayoutHorizontalLayout, HTML, TextField, InPlaceEdit, Label, ListBox, TextArea, encodeXML, URLWhitelist, NoteTakerCardRenderer) {
	"use strict";
	...
	NoteTakerCard.prototype._isFullUrl = function (sWord) {
		return /^(https?|ftp):\/\//i.test(sWord) && URLWhitelist.validate(sWord);
	};
	...
	NoteTakerCard.prototype._isShortUrl = function (sWord) {
		return /^(www\.)/i.test(sWord) && URLWhitelist.validate("http://" + sWord);
	};
