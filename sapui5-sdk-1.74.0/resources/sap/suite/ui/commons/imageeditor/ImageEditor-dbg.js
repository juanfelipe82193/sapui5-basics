sap.ui.define([
	...
	ImageEditor.prototype._onAfterIsReady = function() {
		...
		this._$Container.css({
			width: this._oCanvas.width * this._getScale(),
			height: this._oCanvas.height * this._getScale()
		});
	...
	ImageEditor.prototype._initContainer = function() {
		...
		this._$Container.resizable({
			...
			start: function(oEvent, oUi) {
				...
				jQuery(this).css({
					top: oUi.position.top,
					left: oUi.position.left,
					width: oUi.size.width,
					height: oUi.size.height
				});
			},
