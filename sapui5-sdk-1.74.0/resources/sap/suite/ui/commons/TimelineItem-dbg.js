...
sap.ui.define([
...
], function (jQuery, Control, Text, Toolbar, ToolbarDesign, Link, TextArea, Popover, PlacementType, ToolbarSpacer, Button, Device,
			 ManagedObjectRegister, DateUtils, Icon, MobileLibrary, DateFormat, BaseObject, containsOrEquals, encodeXML, TimelineItemRenderer) {
	"use strict";
	...
	TimelineItem.prototype.setDateTime = function (oDateTime) {
		if (oDateTime && this.getBinding("dateTime") && BaseObject.isA(this.getModel(), "sap.ui.model.odata.v4.ODataModel")) {
			var oInst = DateFormat.getDateTimeInstance({pattern: "yyyy-MM-dd'T'HH:mm:ss.SSSZ"});
	...
	TimelineItem.prototype.getDateTime = function () {
		...
		if (typeof (oDateTime) === "string" && this instanceof sap.suite.ui.commons.TimelineItem && this.getBindingPath("dateTime") && this.getBindingContext()) {
			var sPath = this.getBindingPath("dateTime");
			var oDateTimeActual = this.getBindingContext().getProperty(sPath);
