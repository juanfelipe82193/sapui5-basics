...
sap.ui.define([
	...
	SvgBase.prototype._renderHtmlElement = function (sElem, mStyle, mAttributes) {
		var sHtml = "";
	...
	SvgBase.prototype._renderHtmlIcon = function (sIcon, sClass, sId, sAttr, sTitle) {
		var oIconInfo = IconPool.getIconInfo(sIcon),
			sFontFamily = "";
		...
		if (oIconInfo) {
			...
			var sAriaLabel = sTitle ? " aria-label=\"" + encodeXML(sTitle) + "\" " : "";
