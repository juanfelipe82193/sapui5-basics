...
sap.ui.define([
	...
	GraphMap.prototype._renderMap = function () {
		...
		sSvg = "<svg class=\"sapSuiteUiCommonsNetworkGraphMapSvg\" width=\"100%\" height=\"100%\" viewBox=\"" + sViewBox + "\" " +
		...
		this.$("svg").find("circle").css("stroke-width", iStrokeWidthRating);
	...
	GraphMap.prototype._correctLineWidth = function (oGraph) {
		...
		this.$("svg").css("stroke-width", bCorrectWidth ? this._iStrokeWidth : "1");
	};
