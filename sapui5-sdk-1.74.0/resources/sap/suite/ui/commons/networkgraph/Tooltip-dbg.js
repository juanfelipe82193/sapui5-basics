...
sap.ui.define([
	...
	"sap/m/FlexItemData",
	"sap/ui/core/library"
], function (jQuery, SvgBase, Line, Node, Group, ResponsivePopover, Popover, List, OverflowToolbar, PlacementType, Button,
	...
	Tooltip.prototype.openDetail = function (mArguments) {
		...
		if (mArguments.item instanceof Node && !mArguments.item._hasDetailData()) {
			...
			this._appendHeader(mArguments.item.getTitle(), this._oSimpleTooltip);
