...
sap.ui.define([
	...
	"sap/m/ValueCSSColor",
	"sap/m/CheckBox"
], function (jQuery, library, SvgBase, ManagedObject, Parameters, ValueCSSColor, CheckBox) {
	"use strict";
	...
	ElementBase.prototype._renderClonedControl = function (mOptions, oContent) {
		if (mOptions.mapRender) {
			...
			mOptions.renderManager.write($clone[0].outerHTML);
		} else {
