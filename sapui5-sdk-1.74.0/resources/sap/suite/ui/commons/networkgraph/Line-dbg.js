...
sap.ui.define([
	...
	Line.prototype._showActionButtons = function (oPoint) {
		...
		var sTitle = "<span class=\"sapSuiteUiCommonsNetworkGraphLineTooltipText\">" + oFrom.getTitle() + "</span>";
		...
		sTitle += "<span class=\"sapSuiteUiCommonsNetworkGraphLineTooltipArrow\"></span>" +
			"</br>" +
			"<span class=\"sapSuiteUiCommonsNetworkGraphLineTooltipText\">" + oTo.getTitle() + "</span>";
		...
		if (oParent._isLayered()) {
			...
			$wrapper.css("top", iTop);
			$wrapper.css("left", iLeft);
		}
	};
