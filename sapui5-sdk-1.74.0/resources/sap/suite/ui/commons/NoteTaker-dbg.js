...
sap.ui.define([
	...
	NoteTaker.prototype._handleSearchPopup = function () {
		if (this._bSearchPopupOpen) {
			...
			jQuery(document.getElementById(this.getId() + "-search-panel")).css("right", oPosition.right - 20).slideToggle();
	...
	NoteTaker.prototype._adjustPopupState = function () {
		...
		jQuery(document.getElementById(this.getId() + "-filterTag-panel")).css("left", oTagPosition.left - 20);
		if (this._bFilterTagPopupOpen) {
