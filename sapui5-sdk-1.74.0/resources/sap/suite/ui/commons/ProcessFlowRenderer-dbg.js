...
sap.ui.define([
...
], function (jQuery, ProcessFlowLaneHeader, ProcessFlowZoomLevel, AriaProperties, Device, encodeXML) {
	"use strict";
	...
	ProcessFlowRenderer.render = function (oRm, oControl) {
		...
		oRm.addClass(encodeXML(sStyleZoomLevelClass));
		oRm.writeClasses();
		oRm.write(">");
	...
	ProcessFlowRenderer._writeCounter = function (oRm, oControl, direction) {
		...
		oRm.addClass(encodeXML("suiteUiPFHCounter" + direction));
		oRm.writeClasses();
		oRm.write(">");
		oRm.writeEscaped("0");
		oRm.write("</span>");
