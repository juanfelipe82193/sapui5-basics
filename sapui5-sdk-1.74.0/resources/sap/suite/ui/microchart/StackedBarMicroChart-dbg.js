...
sap.ui.define([
...
], function(jQuery, library, Control, MobileLibrary, Device, FlexBox, MicroChartUtils, ResizeHandler) {
	"use strict";
	...
	StackedBarMicroChart.prototype._calculateChartData = function() {
		...
		if (fMaxValue > fTotalValue) {
			...
			aCalculatedData.push(oItem);
		} else if (aCalculatedData.length > 0 && fWidthPercTotal < 100 && hasAtLeastOnePositiveWidth(aCalculatedData)) {
	 ...
	 *
	 * @private
	 * @param {Object} fNumber The number to be rounded
	 ...
	 *
	 * @param {object[]} aChartData The current chart data objects
