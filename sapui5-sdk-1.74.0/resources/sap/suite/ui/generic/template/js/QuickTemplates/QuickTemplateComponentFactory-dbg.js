...
sap.ui.define([
	...
	function(BaseObject, UIComponent, ResourceModel, coreLibrary, JSONModel, ApplicationController, Log, extend, deepExtend) {
		"use strict";
			...
			return new Promise(function(resolve, reject) {
				...
				oMetaModel.loaded().then(function() {
					...
					if (!oEntitySet || !oEntitySet.entityType) {
						Log.error("The specified entity set " + this.getEntitySet() + " was not found in loaded metadata of service");
						if (reject) {
							reject();
						}
						return;
