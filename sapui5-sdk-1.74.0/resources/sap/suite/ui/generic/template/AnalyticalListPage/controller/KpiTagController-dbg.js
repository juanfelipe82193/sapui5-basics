sap.ui.define([
	...
	"sap/base/Log"
], function (KpiCardController, JSONModel, coreLibrary, Device, ResponsivePopover, Log) {
	"use strict";
	...
	var KpiTagController = {
		...
		createPopover: function (fnOpenOnSucces, oSource) {
			...
			if (!oQualifierSettings) {
				Log.error("KPI settings not found with qualifier.");
				return;
			}
			...
			oModel.getMetaModel().loaded().then(function () {
				...
				me._oKpiCardController._assignSmartTemplateDependencies(me.oState.oTemplateUtils.oCommonUtils, me.oState.oController);
