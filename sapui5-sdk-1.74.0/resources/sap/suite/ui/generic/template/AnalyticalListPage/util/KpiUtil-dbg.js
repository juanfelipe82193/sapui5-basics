sap.ui.define([
	...
	"sap/base/Log"
], function(BaseObject, V4Terms, Locale, NumberFormat, FilterOperator, Log) {
		"use strict";
    ...
    */
	...
	KpiUtil.updateKpiList = function (oKpi, bProcessed) {
		try {
			...
			Log.error("KPI processing failed: " + oKpi.getId() + " : " + oError);
		}
	};
	...
	KpiUtil.addToKpiList = function (mSettings, oKpi) {
		try {
			...
			Log.error("KPI processing failed: " + sKpiId + " : " + oError);
		}
	};
