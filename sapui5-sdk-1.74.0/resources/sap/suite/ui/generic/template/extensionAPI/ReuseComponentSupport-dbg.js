...
sap.ui.define(["sap/ui/core/UIComponent",
	...
	"sap/base/Log"
	], function(UIComponent, JSONModel, reuseComponentHelper, Log) {
		"use strict";
		...
		function mixInto(oComponent, sComponentModelName, bTwoWaySync) {
			...
			if (sComponentModelName) {
				...
				oComponent.setProperty = function(sName, value) {
					...
					Log.debug(oComponent.getId() + ":" + oComponent.getMetadata().getName() + ": setProperty " + sName + "=" + value, sJQueryDebugLogName);
				};
