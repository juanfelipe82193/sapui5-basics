...
define("zen.rt.uiframework/legacyfeeding/zen.rt.components.sdkhtml5chart/charts/SDKColumnDualAxis",
...
SDKBaseChart.extend("sap.zen.SDKColumnDualAxisChart", {
	...
	initCvomChartType : function(){
		this.cvomType = "viz/dual_column";
		// Mapping from cvom errors to message keys
		this.cvomErrorMappings = {
			"50005": "dualcolumn_datamapping_rmd"
		};
	}
});

return sap.zen.SDKColumnDualAxisChart;
});
