...
sap.uiext.inbox.tcm.fI.TCMFunctionImport.prototype.callSearchUsers=function(p,s,e){var S=this.ofIMetadata.SEARCHUSERS;var u=this._createURLParamsArray(p,S);var r=this._createRequest(S.name,u,true,S.httpMethod);return OData.request(r,s,e);};
