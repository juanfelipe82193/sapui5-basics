 ...
 */
sap.ui.core.Control.extend("sap.uiext.inbox.Inbox", /** @lends sap.uiext.inbox.Inbox.prototype */ { metadata : {
 ...
 *
 * @param {function} taskExecURLfnCallBack
 ...
 * @param {function} taskExecURLStatusCallBack
 ...
 *
 * @param {function} taskTypeDynamicFilterCallBack
 ...
 *         {}Predefined sorter that is applied to the Task Collection before displaying the tasks in the Inbox. By default the tasks are sorted on 'CreatedOn' , descending, according to TCM.
 ...
 *
 * @param {object[]} aTaskUniqueIdentifiers
...
sap.uiext.inbox.Inbox.prototype.setNoOfRowsOnTable = function(value) {
    ...
    if (table != undefined)
        table.setVisibleRowCount(parseInt(value));
};
...
sap.uiext.inbox.Inbox.prototype._selectParentRowforElement = function(sId){
	...
	if ($row.length === 1) {
		iIndex = parseInt($row.attr("data-sap-ui-rowindex"));
	}
	var oTable = this._getComponent('listViewTable');
