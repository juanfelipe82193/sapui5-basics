...
sap.ui.define([
	 ...
	 *            rendered
	 */
	DeploymentTypeRenderer.render = function(oRm, oControl) {
	...
	DeploymentTypeRenderer._drawLeftLine = function(oRm,
			oControl, width) {
	...
	DeploymentTypeRenderer._drawRightLine = function(oRm,
			oControl, width) {
