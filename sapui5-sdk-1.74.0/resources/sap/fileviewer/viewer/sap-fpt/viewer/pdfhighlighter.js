...
(function () {
    ...
    exports.PdfHighlighter.prototype = {
        ...
        init: function (highlights, textDivs, textContent, pageNumber) {
            ...
            this.entity2CssClassMapSingleton = window.sap.es.suv.Entity2CssClassMapSingleton.getInstance();
        },
        ...
        highlight: function () {
            ...
            if (this.highlights && Array.isArray(this.highlights)) {
            ...
            for (var i = 0; i < this.highlights.length; ++i) {
                ...
                // css class names shall contain entity type(s) as well as entity for highlighting
                cssClasses = [];
                for (var entityType in highlight.typeMap) {
                    cssClasses.push(entityType);
                    var obj = highlight.typeMap[entityType];
                    for (var text in obj) {
                        cssClasses.push(this.entity2CssClassMapSingleton.mapEntityToCssClass(text));
                    }
                }
                that.doHighlight(highlight, cssClasses);
            }
        ...
        doHighlight: function (highlight, cssClasses) {
