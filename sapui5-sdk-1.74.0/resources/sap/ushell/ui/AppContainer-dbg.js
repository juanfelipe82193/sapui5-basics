...
sap.ui.define([
    ...
    AppContainer.prototype.navTo = function (viewPortId, pageId) {
        var oTargetPage = sap.ui.getCore().byId(pageId),
            sCurrentPageId = this.getCurrentCenterPage(),
            oCurrentPage = sap.ui.getCore().byId(sCurrentPageId) || null,
    ...
    AppContainer.prototype._restoreFocus = function () {
        ...
        if (this.sLastFocusId) {
            sap.ushell.renderers.fiori2.AccessKeysHandler.registerAppKeysHandler(this.fnLastAppKeyHandler);
            oControl = sap.ui.getCore().byId(this.sLastFocusId);
            if (oControl) {
                oControl.focus();
            }
        }
    ...
    AppContainer.prototype._saveFocus = function () {
        ...
        this.fnLastAppKeyHandler = sap.ushell.renderers.fiori2.AccessKeysHandler.getAppKeysHandler();
    };
