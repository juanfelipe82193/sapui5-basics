...
sap.ui.define([
    ...
    "sap/m/library",
    "sap/ushell/library",
    "./EmbeddedSupportErrorMessageRenderer"
], function (
    jQuery,
    Button,
    Dialog,
     ...
     * @class Add your documentation for the newui/launchpad/EmbeddedSupportErrorMessage
     ...
     */
    var EmbeddedSupportErrorMessage = Dialog.extend("sap.ushell.ui.launchpad.EmbeddedSupportErrorMessage", /** @lends sap.ushell.ui.launchpad.EmbeddedSupportErrorMessage.prototype */ {
        metadata: {
            library: "sap.ushell",
            events: {
                afterClose: {}
    ...
    EmbeddedSupportErrorMessage.prototype.open = function () {
        ...
        oContactSupportButton = new Button({
            id: ElementMetadata.uid("supportBtn"),
        ...
        oCloseButton = new Button({
            id: ElementMetadata.uid("closeBtn"),
        ...
        this.setType(DialogType.Message);
