...
sap.ui.define([
    ...
    Tile.prototype.init = function () {
        this.addEventDelegate({
            onsapenter: this._launchTileViaKeyboard.bind(this),
            onsapspace: this._launchTileViaKeyboard.bind(this)
        });
    };
            ...
            if (oEvent.target.tagName !== "BUTTON") {
                ...
                if (oTileUIWrapper.firePress) {
                    ...
                    while (oTileUIWrapper.getContent && !bPressHandled) {
                        // Limitation: since there's no way to know which of the views is the currently presented one,
    ...
    Tile.prototype._redrawRGBA = function () {
        ...
        if (sRGBAvalue && jqTile) {
            ...
            if (oModel && !oModel.getProperty("/animationRendered")) {
