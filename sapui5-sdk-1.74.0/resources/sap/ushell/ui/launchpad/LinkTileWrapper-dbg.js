...
sap.ui.define([
     ...
     * @class A link tile to be displayed in the tile container. This control acts as container for specialized tile implementations.
    ...
    LinkTileWrapper.prototype.ontap = function (/*event, ui*/) {
        ...
        // NOTE: for now, the on press animation is not used, as it caused too much confusion
        return;
    };
