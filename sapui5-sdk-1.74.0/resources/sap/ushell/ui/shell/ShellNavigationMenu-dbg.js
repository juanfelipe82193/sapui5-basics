    ...
    */
    ShellNavigationMenu.prototype._beforeOpen = function () {
        ...
        if (!this.bInitialized) {
            ...
            this.oTitle = new StandardListItem("navMenuInnerTitle").addStyleClass("sapUshellNavigationMenuTitleItem");
    ...
    ShellNavigationMenu.prototype._extendInnerControlsForAccKeyboard = function () {
        ...
        // aria-level=1
        this.oTitle.addCustomData(new AccessibilityCustomData({
            key: "aria-level",
            value: "1",
            writeToDom: true
        }));
