        ...
        _tileOnTapDecorator: function (origFunc) {
            ...
            return function (/*event, ui*/) {
                ...
                if (tileTypeName == "sap.ushell.ui.launchpad.PlusTile") {
                    ...
                    that._putInSessionStorage("sap.ushell.UserActivityLog.lastNavigationActionData", JSON.stringify(lastNavigationActionData));
        ...
        _handleAction: function (sChannelId, sEventId, oData) {
            ...
            switch (sEventId) {
                ...
                case "appOpened":
                    ...
                    this._putInSessionStorage("sap.ushell.UserActivityLog.lastNavigationActionData", JSON.stringify(lastNavigationActionData));
                    break;
