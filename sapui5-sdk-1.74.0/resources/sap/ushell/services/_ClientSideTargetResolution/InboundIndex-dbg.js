...
"sap/base/Log"
    ...
    var oIndexPrototype = Object.create(Object.prototype, {
        getSegment: { value: getSegment },
        getAllInbounds: { value: getAllInbounds },
        getSegmentByTags: { value: getSegmentByTags }
    });
    ...
    function createIndex (aInbounds) {
        ...
        return Object.create(oIndexPrototype, {
            index: { value: oIndex }
        });
    }
