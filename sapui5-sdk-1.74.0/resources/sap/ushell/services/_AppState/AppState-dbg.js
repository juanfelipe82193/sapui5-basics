...
"sap/ui/thirdparty/jquery"
     ...
     * @param {array} iPersistencyMethod //TODO
     *   listing of all relevant persistency methods from section
     * @param {object} oPersistencySettings
     *  collect supplemental information needed for the persistency method
     *
     * @private
     */
    function AppState (oServiceInstance,
                       sKey,
                       bModifiable,
                       sData,
                       sAppName,
        ...
        this._iPersistencyMethod = iPersistencyMethod;
    ...
    function save () {
        ...
        this._oServiceInstance._saveAppState(this._sKey, this._sData, this._sAppName, this._sACHComponent,
            this._bTransient, this._iPersistencyMethod, this._oPersistencySettings).done(function () {
            oDeferred.resolve();
        }).fail(function (sMsg) {
    ...
    AppState.prototype.getPersistencyMethod = function () {
        return this._iPersistencyMethod;
    };
