...
"sap/base/Log"
], function (jQuery, isEmptyObject, Log) {
    "use strict";

    // as the PersonalizationProcessor is currently not in a finished state,
     ...
     * @private
     */
    PersonalizationProcessor.prototype._getItemIndex
            = function (aItemArray, sItemId) {
        var iResult;
     ...
     * @private
     */
    PersonalizationProcessor.prototype
            ._applyRenameGroup = function (sGroupId, sNewTitle, oOriginalSite) {
        var oGroup,
     ...
     */
    PersonalizationProcessor.prototype
            ._applyGroupVisibility = function (sGroupId, bGroupVisibility, oOriginalSite) {
     ...
     */
    PersonalizationProcessor.prototype
            .mixinPersonalization = function (oOriginalSite, oPersonalizationDelta) {
     ...
     * @private
     */
    PersonalizationProcessor.prototype._applyAddGroups = function (
            oOriginalSite, oPersonalizationDelta
    ) {
        ...
        if (
            ...
            Object.keys(oPersonalizationDelta.addedGroups).forEach(function (sGroupId) {
                oOriginalSite.groups[sGroupId] = oPersonalizationDelta.addedGroups[sGroupId];
     ...
     */
    PersonalizationProcessor.prototype
            ._checkRenameGroup = function (
                sGroupId, oPersonalizedSiteGroups, oOriginalSiteGroups, oPersonalizationDelta
    ) {
    ...
    /**
     * Extracts delta for changes in the setting of tiles. The outcome is directly
     * added to the mandatorily given oPersonalizationDelta.
     *
     * @param {object} oPersonalizedSite Personalized site which the delta should be computed for.
     *
     * @param {object} oPersonalizationDelta (Partially) computed delta which may be complemented.
     */
    PersonalizationProcessor.prototype
        ._checkTileSettings = function (oPersonalizedSite, oPersonalizationDelta) {
            if (!oPersonalizedSite.modifiedTiles) {
                return;
            }

            oPersonalizationDelta.modifiedTiles = oPersonalizedSite.modifiedTiles;
        };
     ...
     *
     * @param {object} oPersonalizationDelta The personalization deltat to be applied.
     */
    PersonalizationProcessor.prototype
        ._applyTileSettings = function (oSite, oPersonalizationDelta) {
                        ...
                        oGroup.payload[sTileType].some(function (oTile) {
                            ...
                            aModifiedTiles.some(function (oUserTile, iIndex) {
                                if (oUserTile.id === oTile.id) {
                                    ...
                                    // Conclude the search when a matching modified tile
                                    // is found.
                                    return true;
                                }
            ...
            oSite.modifiedTiles = oPersonalizationDelta.modifiedTiles;
        };
     ...
     */
    PersonalizationProcessor.prototype
            ._checkGroupVisibility = function (
                sGroupId, oPersonalizedSiteGroups, oOriginalSiteGroups, oPersonalizationDelta
    ) {
        if (sGroupId && oPersonalizedSiteGroups && oOriginalSiteGroups) {
            if (oOriginalSiteGroups[sGroupId]) {
     ...
     *
     * @returns {boolean}
     *   TRUE, if group was added successfully, FASLSE otherwise.
     *
     * @private
     */
    PersonalizationProcessor.prototype
            ._addGroupToPersonalizationDelta = function (
                oPersonalizedSite, oPersonalizationDelta, sGroupId
    ) {
        var bSuccess = false,
            aGroupsOrder,
        ...
        if (oPersonalizedSite && oPersonalizedSite.site && oPersonalizedSite.site.payload
            ...
            oPersonalizationDelta.addedGroups[sGroupId].identification = jQuery.extend({}, oNewPersonalizedGroup.identification);
            // TODO: assumtion is: this is not needed...
            oPersonalizationDelta.addedGroups[sGroupId].payload = jQuery.extend({}, oNewPersonalizedGroup.payload);
     ...
     */
    PersonalizationProcessor.prototype
        .extractPersonalization = function (oPersonalizedSite, oOriginalSite) {
            var oDeferred = new jQuery.Deferred(),
            ...
            if (oOriginalSite && oOriginalSite._version) {
            ...
            if (oPersonalizedSite && oPersonalizedSite.groups && oOriginalSite && oOriginalSite.groups) {
                ...
                this._checkTileSettings(oPersonalizedSite, oPersonalizationDelta);
                ...
                if (oExtractHelper.oPersonalizationDelta.movedTiles
                    && isEmptyObject(oExtractHelper.oPersonalizationDelta.movedTiles)
                ) {
                    delete (oExtractHelper.oPersonalizationDelta.movedTiles);
                }

                // Cleanup 3: Make tests easier (and do not store unnecessary bits):
                if (oExtractHelper.oPersonalizationDelta.movedLinks
                    && isEmptyObject(oExtractHelper.oPersonalizationDelta.movedLinks)
                ) {
     ...
     *
     * @returns {boolean}
     *   TRUE, if test was successfull (e.g. possible), FALSE otherwise.
     *
     * @private
     */
    PersonalizationProcessor.prototype._checkRemoveGroup
            = function (oPersonalizedSite, oPersonalizationDelta, sOriginalGroupId) {
        var bSuccess = false;
     ...
     *
     * @returns {boolean}
     *   TRUE, if removing group was successfull, FALSE otherwise.
     *
     * @private
     */
    PersonalizationProcessor.prototype
            ._applyRemoveGroup = function (oOriginalSite, sGroupId) {
        var oOriginalGroups,
            aGroupsOrder,
            iGroupPos;
     ...
     * @private
     */
    PersonalizationProcessor.prototype._checkMoveGroup
            = function (oPersonalizedSite, oOriginalSite, oPersonalizationDelta) {
     ...
     * @private
     */
    PersonalizationProcessor.prototype._applyMoveGroup = function (
            oOriginalSite, oPersonalizationDelta
    ) {
        var bSuccess = false;
     ...
     * @private
     */
    PersonalizationProcessor.prototype._getHashedItemsFromSite
            = function (oSiteObject) {
        var oResult = null;
     ...
     */
    PersonalizationProcessor.prototype._getExtractHelperObject
            = function (oOriginalSite, oPersonalizedSite, oPersonalizationDelta) {
        var oResult = null;
     ...
     * @private
     */
    PersonalizationProcessor.prototype._extractFromOriginalSiteOneGroup
            = function (oOriginalSite, oExtractHelper, sGroupId, sItemType) {
        var bSuccess = false,
            aOriginalItems,
            oMovedTiles,
            fMarkAsReMoved,
    ...
    /**
     * Checks for changes to the item (tile, link) itself and save that change, if any one was found.
     *
     ...
     *
     * @returns {boolean}
     *   TRUE, if a change on the destinated item was detected and saved in "oExtractHelper",
     *   FALSE otherwise.
     *
     * @private
     */
    PersonalizationProcessor.prototype._handleItemChangeExtract
            = function (oExtractHelper, sGroupId, sItemType) {
        // TODO: Implement this method.
        // For now:
        return false; // Nothing detected because not tried it.
    };
    ...
    PersonalizationProcessor.prototype._extractFromPersonalizedSiteOneGroup
            = function (oPersonalizedSite, oExtractHelper, sGroupId, sItemType) {
        var bSuccess = false,
            oMovedTiles,
            aTileOrder,
        ...
        if (oExtractHelper
            ...
            aPersonalizedItems.forEach(function (oItem, iIndex) {
                // Build tileOrder array (inkrementally):
                aTileOrder.push(oItem.id);

                if (oExtractHelper.oHashedItemsOriginal[sGroupId]
                        && oExtractHelper.oHashedItemsOriginal[sGroupId][sItemType][oItem.id]
                ) {
                    ...
                    that._handleItemChangeExtract(oExtractHelper, sGroupId, sItemType); // Detect changes and record them, if needed.
                } else {
     ...
     * @private
     */
    PersonalizationProcessor.prototype._cleanupRemovedGroups
            = function (oOriginalSite, oPersonalizationDelta) {
        var aItems,
            oMoveTileEntry;
     ...
     */
    PersonalizationProcessor.prototype
            ._setItemOrderOnSiteCollection = function (aOriginalSiteItems, aItemOrder) {
        var bSuccess = true,
        ...
        if (!Array.isArray(aOriginalSiteItems)
                || !Array.isArray(aOriginalSiteItems)
                || (aOriginalSiteItems.length !== aItemOrder.length)
        ) {
            return false;
        }
        ...
        for (iIndex = 0; iIndex < aItemOrder.length; iIndex++) {
            ...
            if (oCurrentOriginalItem && sCurrentItemId === oCurrentOriginalItem.id) {
                ...
                // Take it from saved items occuring earlier, push it, clean up and continue:
     ...
     */
    PersonalizationProcessor.prototype
            ._setItemOrderOnSiteGroupForItemType = function (oOriginalGroup, oDeltaGroup, sItemType) {
        var bSuccess = true,
            bTempSuccess,
            sItemOrder;
     ...
     */
    PersonalizationProcessor.prototype
            ._setItemOrderOnSite = function (oOriginalSite, oPersonalizationDelta) {
        var bSuccess = true,
            bTempSuccess,
            that = this;

        if (oOriginalSite.groups
                && oPersonalizationDelta.groups
        ) {
            Object.keys(oPersonalizationDelta.groups).forEach(function (sGroupId) {
                if (oPersonalizationDelta.groups[sGroupId]
                        && oOriginalSite.groups[sGroupId]
                ) {
     ...
     */
    PersonalizationProcessor.prototype
            ._applyMoveItemsWithoutOrder = function (oOriginalSite, oPersonalizationDelta, sItemType) {
        var bSuccess = true,
            bTempSuccess,
            sTypeKey,
        ...
        // Private inner function: Adds given item (tile or link) at end of corresponding array of
        //    specified group. Note: Ordering will be done later in another method.
            ...
            Object.keys(oPersonalizationDelta[sTypeKey]).forEach(function (sItemId) {
                ...
                if (oDeltaItem.fromGroup) {
                    if (oDeltaItem.toGroup) {
                        ...
                        && oOriginalSite.groups[oDeltaItem.fromGroup].payload
                        && Array.isArray(oOriginalSite.groups[oDeltaItem.fromGroup].payload[sItemType])) { // Surely a removed item. Unfortunately we don't have position of removed item, so we have to iterate
                        aOriginalItems = oOriginalSite.groups[oDeltaItem.fromGroup].payload[sItemType];
                        iItemIndex = that._getItemIndex(aOriginalItems, sItemId);
                        if (iItemIndex >= 0) {
     ...
     *
     * @returns {boolean}
     *   TRUE if applying changes was sucessfull.
     *   FALSE in case of at least one error done to invalid input data.
     *
     * @private
     */
    PersonalizationProcessor.prototype._applyItemChanges
            = function (oOriginalSite, oPersonalizationDelta) {
