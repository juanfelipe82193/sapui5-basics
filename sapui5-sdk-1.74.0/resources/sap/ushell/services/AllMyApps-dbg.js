...
sap.ui.define([
    ...
    /**
     * @class A UShell service for registering an external provider of content (i.e., data source) to display All My Apps UI in the SAP Fiori launchpad.<br><br>
    ...
    function AllMyApps(oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        this.isEnabled = function () {
            bEnabled = (!oServiceConfig || (oServiceConfig.enabled !== false)) ? true : false;
            return bEnabled;
        };
        ...
        this.isHomePageAppsEnabled = function () {
            return (!oServiceConfig || (oServiceConfig.showHomePageApps !== false)) ? true : false;
        };
        ...
        this.isCatalogAppsEnabled = function () {
            return (!oServiceConfig || (oServiceConfig.showCatalogApps !== false)) ? true : false;
        };
        ...
        this.isExternalProviderAppsEnabled = function () {
            return (!oServiceConfig || (oServiceConfig.showExternalProviders !== false)) ? true : false;
        };
        ...
        */
        ...
        this.getProviderTypeEnum = function () {
            return oProviderTypeEnum;
        };
