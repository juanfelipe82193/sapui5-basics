...
sap.ui.define([
    ...
    function ShellNavigation (oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        this._navigationFilterForForwardingToRegisteredRouters = function (sHash) {
            ...
            if (bMatchedFLPRouters) {
                var AppLifeCycle = sap.ushell.Container.getService("AppLifeCycle"),
                    ...
                    bIsApp = oCurrentApplication && oCurrentApplication.componentInstance && !oCurrentApplication.homePage,
                    oAppRouter;

                if (bIsApp) {
                    oAppRouter = oCurrentApplication.componentInstance.getRouter();
        ...
        /**
         * Returns a boolean value indicating whether only the first navigation occcurred.
         *
        ...
        this._enableHistoryEntryReplacedDetection = function () {
            ...
            var fnOriginalSetHash = hasher.setHash,
                fnOriginalReplaceHash = hasher.replaceHash;

            hasher.setHash = function () {
                this._hashChangedByApp = true;
                this._lastHashChangeMode = "setHash";
                return fnOriginalSetHash.apply(hasher, arguments);
            }.bind(this);

            hasher.replaceHash = function () {
                this._hashChangedByApp = true;
                this._lastHashChangeMode = "replaceHash";
                return fnOriginalReplaceHash.apply(hasher, arguments);
            }.bind(this);
        };
        ...
        this.registerNavigationFilter(this._navigationFilterForForwardingToRegisteredRouters.bind(this));
    }
