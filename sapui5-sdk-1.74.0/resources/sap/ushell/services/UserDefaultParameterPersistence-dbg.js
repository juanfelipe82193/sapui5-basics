 ...
 * Values are be client side cached (Browser HTTP Cache), if a appropriate cache-busting is used.
 *
...
sap.ui.define([
     ...
     * others MUST call <code>sap.ushell.Container.getService("UserDefaultParameterPersistence")</code>.
        ...
        if (this._oData[sParameterName]) {
            ...
            this._oAdapter.loadParameterValue(sParameterName).done(function (oValue) {
                ...
                if (that._testValue(oCleansedValue)) {
                    ...
                    Log.error("flawed value returned from persistence");
