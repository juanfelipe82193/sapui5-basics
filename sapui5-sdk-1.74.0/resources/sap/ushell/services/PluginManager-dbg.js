...
sap.ui.define([
    ...
    "sap/ushell/utils"
], function (fnGetExtensions, jQuery, UriParameters, utils) {
    "use strict";
    ...
    function PluginManager () {
         ...
         * @returns {Promise} An ECMA6 promise returned by the call of sap.ui.component().
         * @since 1.38
         * @private
         */
        ...
        this.registerPlugins = function (oPlugins) {
            ...
            utils.addTime("PluginManager.registerPlugins");
            ...
            Object.keys(oPlugins).sort().forEach(function (sPluginName) {
                ...
                if (oCurrentPlugin && oCurrentPlugin.hasOwnProperty("module")) {
                    jQuery.sap.log.error("Plugin " + sPluginName
                        ...
                        S_COMPONENT_NAME);
                    // The following line of code should be removed for the next SP, so that plugins defined as modules are not allowed anymore.
        ...
        this.loadPlugins = function (sPluginCategory) {
            ...
            utils.setPerformanceMark("FLP -- PluginManager.startLoadPlugins");
            utils.addTime("PluginManager.startLoadPlugins[" + sPluginCategory + "]");
            ...
            if (aSupportedPluginCategories && Array.prototype.indexOf.call(aSupportedPluginCategories, sPluginCategory) !== -1) {
                ...
                if (Object.keys(that._oPluginCollection[sPluginCategory]).length > 0) {
                    ...
                    if (new UriParameters(window.location.href).get("sap-ushell-xx-pluginmode") === "discard" && sPluginCategory === "RendererExtensions") {
                    ...
                    jQuery.when.apply(undefined, aPluginPromises)
                        .done(function () {
                            utils.addTime("PluginManager.endLoadPlugins[" + sPluginCategory + "]");
                            utils.setPerformanceMark("FLP -- PluginManager.endLoadPlugins");
