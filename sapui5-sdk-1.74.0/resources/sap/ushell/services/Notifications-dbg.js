...
sap.ui.define([
    ...
    function Notifications (oContainerInterface, sParameters, oServiceConfiguration) {
        ...
        this.init = function () {
            ...
            sap.ui.getCore().getEventBus().subscribe("launchpad", "setConnectionToServer",
        ...
        this.destroy = function () {
            ...
            sap.ui.getCore().getEventBus().unsubscribe("launchpad", "setConnectionToServer",
                this._onSetConnectionToServer, this);
        };
        ...
        /**
         * If the instance of Personalizer (oUserSettingsPersonalizer) is not yet defined - then create it and return oUserSettingsPersonalizer
         */
         ...
         *
         * Issues two calles to the Notifications channel backend system in order to check whether settigns feature and Push to Mobile features are supported
         */
         ...
         * If the websocket connection can not be established, the polling start automaticly after failed attempt
         *
         * @since 1.71.0
         * @private
         */
