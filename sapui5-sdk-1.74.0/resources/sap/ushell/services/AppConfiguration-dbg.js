...
sap.ui.define([
    ...
    function AppConfiguration () {
        ...
        /**
         * Due to performace changes on component (app) loading, it is possible that an application would be initialized before
        ...
        this.addActivity = function (oRecentActivity) {
            ...
            return oContainer && oContainer.getService("UserRecents").addActivity(oRecentActivity);
        };
        ...
        this.addApplicationSettingsButtons = function (aButtons) {
             ...
             * However currently it may happend in case abap is loading the application inside when the target is resolved in abap.js
        ...
        this.setApplicationFullWidth = function (bValue) {
            sap.ushell.components.applicationIntegration.AppLifeCycle.setApplicationFullWidth(bValue); // TODO: pending dependency migration
        };

        /**
         * Get a settings control to display about dialog and system infos.
         *
         * @returns {object} jQuery.deferred.promise object that when resolved,
         *   returns a settings control which can be embedded where ever its needed
         * @since 1.48
         * @private
         */
         ...
         * Get a settings control to display about dialog and system infos.
         *
         * @returns {sap.ushell.ui.footerbar.SettingsButton} a settings control which can be embedded where ever its needed
        ...
        this.getSettingsControl = function () {
            ...
            SettingsControlContructor = ObjectPath.get(sOldSettingButtonPath || "");
            return new SettingsControlContructor();
        };
