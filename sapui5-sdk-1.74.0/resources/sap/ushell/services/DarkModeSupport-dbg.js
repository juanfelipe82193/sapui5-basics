...
sap.ui.define([
    ...
    DarkModeSupport.prototype.setup = function () {
        ...
        sap.ui.getCore().attachThemeChanged(this.themeChangedCallback);
    ...
    DarkModeSupport.prototype.destroy = function () {
        ...
        if (this.initialized) {
            sap.ui.getCore().detachThemeChanged(this.themeChangedCallback);
            this.themeChangedCallback = null;
    ...
    DarkModeSupport.prototype.canAutomaticallyToggleDarkMode = function () {
        ...
        return isColorSchemeQuerySupported && !UriParameters.fromURL(window.location.href).has("sap-theme");
    };
    ...
    DarkModeSupport.prototype.enableDarkModeBasedOnSystem = function () {
        if (!this.initialized) {
            Log.warning("Automatic dark mode detection cannot be enabled, because the DarkModeSupport sevice was not setup.");
            return;
        }
        if (!this.canAutomaticallyToggleDarkMode()) {
