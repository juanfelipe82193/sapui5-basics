...
sap.ui.define([
...
], function (URI, utils, UriParameters) {
    "use strict";
    ...
    function URLParsing () {
        ...
        this.parseParameters = function (sParams) {
            ...
            return new UriParameters(sParams).mParams || {};
        };
        ...
        this.paramsToString = function (oParams) {
            return utils.urlParametersToString(oParams);
        };
        ...
        this.privparamsToString = function (oParams, sDelimiter, sAssign) {
            return utils.urlParametersToString(oParams, sDelimiter, sAssign);
        };
