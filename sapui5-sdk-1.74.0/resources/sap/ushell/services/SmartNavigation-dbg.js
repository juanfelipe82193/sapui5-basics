...
(function () {
    ...
    sap.ui.define([
        ...
        function ConstructorForUshellContainer (oContainerInterface, sParameters, oServiceConfig) {
     ...
     * @since 1.44.0
     */
    function SmartNavigation (oContainerInterface, sParameters, oServiceConfig, oPrivate, oAppConfiguration, oPersonalizationStore, oURLParsing, oCrossAppNav, utils) {
        if (!SmartNavigation.instance) {
            Object.defineProperty(SmartNavigation, "instance", {
                value: Object.create(null, {
                     ...
                     *
                     * @returns {jQuery.Deferred.promise} A promise that resolves with an array of link objects
                    ...
                    getLinks: {
                        value: function (oArgs) {
                            ...
                            if (!oPrivate.isTrackingEnabled(oServiceConfig, utils)) {
                                return jQuery.when(aAllLinks);
                            }
                            var oCurrentApplication = oAppConfiguration.getCurrentApplication(),
                                sFromCurrentShellHash = oCurrentApplication.sShellHash,
                                oAppComponent = oCurrentApplication.componentHandle;
                            ...
                            if (!sFromCurrentShellHash) {
                                ...
                                jQuery.sap.log.warning(
                                    "Call to SmartNavigation#getLinks() simply delegated to CrossApplicationNavigation#getLinks()"
                                    + " because oAppConfiguration#getCurrentApplication()#sShellHash evaluates to undefined."
                                );
                    ...
                    toExternal: {
                        value: function (oArgs/*, oComponent*/) {
                            var _arguments = arguments,
                                sDestinationShellHash = oPrivate.getHashFromOArgs(oArgs.target, oURLParsing),
                                fnToExternal = function () {
                                    return oCrossAppNav.toExternal.apply(oCrossAppNav, _arguments);
                                };
                    ...
                    hrefForExternal: {
                        value: function () {
                            var oHrefList = oCrossAppNav.hrefForExternal.apply(oCrossAppNav, arguments);
                            return oHrefList;
                        }
                    },
                    ...
                    getPrimaryIntent: {
                        value: function () {
                            var oPrimaryIntent = oCrossAppNav.getPrimaryIntent.apply(oCrossAppNav, arguments);
                            return oPrimaryIntent;
                        }
                    },
                     ...
                     *
                     * @param {object} oArguments The navigation target as object, for example:
                        ...
                        value: function (oArgs) {
                            if (!oPrivate.isTrackingEnabled(oServiceConfig, utils)) {
                                jQuery.sap.log.debug(
                                    "Call to SmartNavigation#trackNavigation() ignored"
                                    + " because Service is not enabled via Configuration",
                                    null,
                                    "sap.ushell.services.SmartNavigation"
                                );
                            ...
                            var oTarget = oArgs.target,
                                oCurrentApplication = oAppConfiguration.getCurrentApplication(),
                                sFromCurrentShellHash = oCurrentApplication.sShellHash,
                                sDestinationShellHash;
                     ...
                     * @private
                     */
                    constructor: { value: SmartNavigation }
                })
            });
        }
