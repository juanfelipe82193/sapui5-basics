...
sap.ui.define([
...
], function (Config, URI, ObjectPath, jQuery) {
    "use strict";
    ...
    function getPropertyValueOrEmptyString (sPropertyValuePath, oObject) {
        return ObjectPath.get(sPropertyValuePath, oObject) || "";
    }

    /**
     * This method MUST be called by the Unified Shell's container only, others MUST call <code>sap.ushell.Container.getService("EndUserFeedback")</code>.
     ...
     * @param {object} oAdapter the service adapter for the end user feedback service, as already provided by the container
     * @param {object} oContainerInterface the interface provided by the container
     * @param {string} sParameters the runtime configuration specified in the <code>sap.ushell.Container.getService()</code> call (not evaluated yet)
     * @param {object} oServiceConfiguration the service configuration defined in the bootstrap configuration;
     *   the boolean property <code>enabled</code> controls the service enablement
     *
     ...
     *   </pre>
     *
     * Platform implementations can also enable it dynamically by modification of the bootstrap configuration during boot time.
     *
     * @public
     * @constructor
    ...
    function EndUserFeedback (oAdapter/*, oContainerInterface, sParameters, oServiceConfiguration*/) {
        ...
        /**
         * @returns {String} the legal text for the feedback dialog box
         * @public
        ...
        /**
         * Checks if the service is enabled.<p>
        ...
        this.isEnabled = function () {
            var oDeferred = new jQuery.Deferred(),
                bIsServiceEnabled = Config.last("/core/extension/EndUserFeedback");
         ...
         * @return {string} Path of the given URL (based on URI-API).
         * @private
         * @since 1.30.0
         */
