...
sap.ui.define([
    ...
    var LaunchPageAdapter = function (oUnused, sParameter, oAdapterConfiguration) {
        ...
        this._createTileInstance = function (oTileData, sTileType) {
            var oTileUI,
                oDfd = jQuery.Deferred(),
                oTileImage = this._getImageContent({ src: oTileData.properties.icon });
                ...
                default:
                    ...
                    if (!oTileObject) {
                        if (!jQuery.sap.getObject(oTileData.tileType)) {
                            jQuery.sap.require(oTileData.tileType); // TODO: remove jQuery.sap
                        }
        ...
        this.getCatalogTileKeywords = function (oCatalogTile) {
            return jQuery.merge([], jQuery.grep(
                jQuery.merge(
                    [
                        oCatalogTile.title,
        ...
        this.deleteBookmarks = function (sUrl) {
            ...
            for (iGroupIndex = 0; iGroupIndex < aConfigGroups.length; iGroupIndex++) {
                ...
                for (iTileIndex = oGroup.tiles.length - 1; iTileIndex >= 0; iTileIndex--) {
