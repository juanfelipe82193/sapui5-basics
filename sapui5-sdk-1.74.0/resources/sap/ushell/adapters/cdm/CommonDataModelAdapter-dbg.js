...
sap.ui.define([
...
], function (URI, Log, Version, UriParameters, jQuery) {
    "use strict";
        ...
        this.oCdmSiteDataRequestPromise.done(function (oSiteData) {
            ...
            if (oSiteDataCopy.personalization) {
                ...
                if (Object.keys(oSiteDataCopy.personalization).length > 0 && !that._isPersonalizationVersionValid(sSiteVersion, sPersonalizationVersion)) {
                    Log.error("Personalization version is not compatible to the site version and will not be loaded. Please proceed to personalize the homepage again if needed. Personalization version: " + sPersonalizationVersion + "; Site version: " + sSiteVersion);
                    oDeferred.resolve();
                    return;
                }
     ...
     * -- Note: This is due to a technical limitation. We did not have a personalization version in the past so we cannot simply compare 2.0.0 and 1.0.0. In fact those two are not compatible!
