...
sap.ui.define([
...
], function (URI, oApplicationTypeUtils, oSystemAlias, oCSTRUtils, oParameterMapping, jQuery) {
    "use strict";
    ...
    function generateTRResolutionResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        if (
            ...
            return constructFullWebguiResolutionResult(oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver);
        }
        ...
        if (
            ...
            return constructWebguiNowrapResult(oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver);
        }
        ...
        if (
            ...
            return constructWebguiWrapResult(oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver);
        }
        ...
        if (
            ...
            return constructNativeWebguiNowrapResult(oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver);
        }
        ...
        if (
            ...
            return constructNativeWebguiWrapResult(oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver);
        }
    ...
    function buildNativeWebGuiURI (sTcode, sSapSystem, sSapSystemDataSrc, fnExternalSystemAliasResolver) {
        ...
        oURI = new URI(sUrl);
        return oSystemAlias.spliceSapSystemIntoURI(oURI, oSystemAlias.LOCAL_SYSTEM_ALIAS, sSapSystem, sSapSystemDataSrc, "NATIVEWEBGUI", oSystemAlias.SYSTEM_ALIAS_SEMANTICS.apply, fnExternalSystemAliasResolver);
    }
    ...
    function injectEffectiveParametersIntoWebguiPobjectParam (sQuery, oParamsToInject, sQueryParamDelimiter, sQueryParamAssignDelimiter) {
        ...
        amendGuiParam("P_OBJECT", sQuery, sQueryParamDelimiter, sQueryParamAssignDelimiter, function (sParamNameAndValueDoubleEncoded) {
        ...
        var oAmendResult = amendGuiParam("P_OBJECT", sQuery, sQueryParamDelimiter, sQueryParamAssignDelimiter, function (sFoundParamNameAndValue) {
    ...
    function constructNativeWebguiWrapResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        return new Promise(function (fnResolve, fnReject) {
            oSystemAlias.spliceSapSystemIntoURI(oWebguiURI, oInboundResolutionResult.systemAlias, sSapSystem, sSapSystemDataSrc, "NATIVEWEBGUI", oInboundResolutionResult.systemAliasSemantics || oSystemAlias.SYSTEM_ALIAS_SEMANTICS.applied, fnExternalSystemAliasResolver)
                .fail(fnReject)
    ...
    function constructFullWebguiResolutionResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        return new Promise(function (fnResolve, fnReject) {
            buildNativeWebGuiURI(oInbound.resolutionResult["sap.gui"].transaction, sSapSystem, sSapSystemDataSrc, fnExternalSystemAliasResolver).done(function (oURIWithSystemAlias) {
                oParameterMapping.mapParameterNamesAndRemoveObjects(oMatchingTarget);
                var oResolutionResult = blendParamsIntoNativeWebGUI(oMatchingTarget.inbound, oMatchingTarget.mappedIntentParamsPlusSimpleDefaults, oURIWithSystemAlias);
    ...
    function constructWebguiWrapResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        return new Promise(function (fnResolve, fnReject) {
            oSystemAlias.spliceSapSystemIntoURI(oWebguiURI, oInboundResolutionResult.systemAlias, sSapSystem, sSapSystemDataSrc, "WEBGUI", oInboundResolutionResult.systemAliasSemantics || oSystemAlias.SYSTEM_ALIAS_SEMANTICS.applied, fnExternalSystemAliasResolver)
                .fail(fnReject)
                .done(function (oWebguiURI) {
                    // Reconstruct the final url
                    // ASSUMPTION: there are no relevant parameters in the Webgui url, but only Webgui parameters.
    ...
    function constructWebguiNowrapResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        return new Promise(function (fnResolve, fnReject) {
            oSystemAlias.spliceSapSystemIntoURI(oWebguiURI, oInboundResolutionResult.systemAlias, sSapSystem, sSapSystemDataSrc, "WEBGUI", oResolutionResult.systemAliasSemantics || oSystemAlias.SYSTEM_ALIAS_SEMANTICS.applied, fnExternalSystemAliasResolver)
                .fail(fnReject)
                .done(function (oWebguiURI) {
                    // important to extract here to get a potentially modified client
                    var sEffectiveStartupParams = oApplicationTypeUtils.getURLParsing().paramsToString(oEffectiveParameters);
    ...
    function constructNativeWebguiNowrapResult (oMatchingTarget, sBaseUrl, fnExternalSystemAliasResolver) {
        ...
        return new Promise(function (fnResolve, fnReject) {
            oSystemAlias.spliceSapSystemIntoURI(oWebguiURI, oResolutionResult.systemAlias, sSapSystem, sSapSystemDataSrc, "NATIVEWEBGUI", oResolutionResult.systemAliasSemantics || oSystemAlias.SYSTEM_ALIAS_SEMANTICS.applied, fnExternalSystemAliasResolver)
                .fail(fnReject)
                .done(function (oWebguiURI) {
                    var oResolutionResult = blendParamsIntoNativeWebGUI(oMatchingTarget.inbound, oMatchingTarget.mappedIntentParamsPlusSimpleDefaults, oWebguiURI);
    ...
    function blendParamsIntoNativeWebGUI (oInbound, oMappedIntentParamsPlusSimpleDefaults, oWebguiURI) {
        ...
        var sEffectiveParamsToAppend = oApplicationTypeUtils.getURLParsing().paramsToString(oEffectiveParametersToAppend);
        sParamsInterpolated = [
            sParamsInterpolated,
        ...
        return new Promise(function (fnResolve, fnReject) {
            ...
            buildNativeWebGuiURI( sSapTcode, sSapSystem, sSapSystemDataSrc, fnExternalSystemAliasResolver)
                .done(function (oURI) {
                    ...
                    // rename Parameters
                    oParameterMapping.mapParameterNamesAndRemoveObjects(oMatchingTarget);
                    var oResolutionResult = blendParamsIntoNativeWebGUI(oMatchingTarget.inbound, oMatchingTarget.mappedIntentParamsPlusSimpleDefaults, oURI);
                    if (oResolutionResult && oMatchingTarget.inbound && oMatchingTarget.inbound.resolutionResult && oMatchingTarget.inbound.resolutionResult["sap.platform.runtime"]) {
                        oResolutionResult["sap.platform.runtime"] = oMatchingTarget.inbound.resolutionResult["sap.platform.runtime"];
                    }
                    oResolutionResult["sap-system"] = sSapSystem;
