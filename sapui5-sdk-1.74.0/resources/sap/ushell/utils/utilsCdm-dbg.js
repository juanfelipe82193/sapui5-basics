...
sap.ui.define([
...
], function (oUshellUtils, oObjectOperations, fnClone, jQuery, Log, ObjectPath) {
    "use strict";

    function getMember (oObject, sAccessPath) {
        return oObjectOperations.getMember(oObject, sAccessPath);
    }
    ...
    function mapOne (sKey, oSrc, oApp) {
        ...
        oSrc = fnClone(oSrc); // do not modify input parameters
        oApp = fnClone(oApp); // do not modify input parameters
                ...
                try {
                    ...
                    if (oApplicationInbounds) {
                        ...
                        lst2.forEach(function (sInboundKey) {
                            ...
                            var r = that.mapOne(sInboundKey, oInbound, oApp);
                            if (r) {
                                aInbounds.push(r);
                            }
                        });
