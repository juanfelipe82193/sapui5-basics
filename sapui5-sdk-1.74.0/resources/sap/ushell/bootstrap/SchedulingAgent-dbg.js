...
sap.ui.define([
    ...
    var SchedulingAgent = {
         ...
         *
         * @returns {{sStepType: string, oData: object, bConfigOk}}
            ...
            do {
                ...
                if (oNextStep.sStatus === oStatusDefinitions.STEP) {
                    ...
                    if (!oStepConfig.bConfigOk) {
                        ...
                        var oPromise = FLPLoader.loadComponentByComponentCreate(oStepConfig.oData);
                        ...
                        oPromise.then(
                            function () {
                                state.setForLoadingStep(oStepConfig.sStepName, state.id.loadingStep.InProgress, "", "Step's promise has resolved");
                                delete this.oComponentsLoading[oStepConfig.sStepName];
                                EventHub.emit("StepDone", oStepConfig.sStepName);
                        }.bind(this),
                            function () {
                                state.setForLoadingStep(oStepConfig.sStepName, state.id.loadingStep.FatalError, "", "Step's promise failed");
                                delete this.oComponentsLoading[oStepConfig.sStepName];
                                EventHub.emit("StepFailed", oStepConfig.sStepName);
                            }.bind(this)
                        );
                    }
                }
