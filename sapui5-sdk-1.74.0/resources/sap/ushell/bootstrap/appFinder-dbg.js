...
(function () {
    ...
    var sBaseUrl,
        oBootScript = document.querySelector("script[src$=\"sap/ushell/bootstrap/appFinder.js\"]");

    if (!oBootScript) {
        throw new Error("cdm.js: could not identify homepage bootstrap script tag!");
    }

    sBaseUrl = oBootScript.src.match(/(.*\/)sap\/ushell\/bootstrap\/appFinder\.js$/i)[1];
    ...
    loadScripts([
        ...
        loadScripts([
            ...
            loadScripts([
                ...
                sap.ui.require([
                    "sap/ushell/bootstrap/appfinder/appFinder-dev"
                ], function (/*cdmDefDev*/) {
