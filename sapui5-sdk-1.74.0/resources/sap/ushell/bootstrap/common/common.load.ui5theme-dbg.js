...
sap.ui.define([
...
], function (bootPath, jQuery) {
    "use strict";

    function applyBootTheme (oBootTheme) {
        if (!oBootTheme || !oBootTheme.theme) {
            jQuery.sap.log.error("No boot theme could be applied", null,
        ...
        jQuery.sap.log.debug("Boot theme applied: theme = '" + oBootTheme.theme +
    ...
    function includePreloadStylesheet (sTheme, sThemeBaseUrl) {
        ...
        jQuery.sap.includeStyleSheet(sThemePrefix + "/" + sFileName, "sap-ui-theme-sap.fiori");
    }
