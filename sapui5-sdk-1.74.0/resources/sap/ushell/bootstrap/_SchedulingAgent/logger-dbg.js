...
sap.ui.define([
    ...
    return {
         ...
         * @returns {{time:number, type:string, id:string, status:string, parameter:object, remark:string, byModule:string}[]} Status history of status objects
         * @protected
         */
        getHistory: function () {
            return aHistory;
        ...
        dumpHistory: function (id) {
            ...
            if (id) {
                ...
                console.table(aHistory); // eslint-disable-line no-console
            }
