...
/**
 * @fileOverview the URL Template Parameter parser.
 *
 * This file contains utilities to parse an entire set of template parameter
 * definitions. This parser allows to log what is understood by the machine
 * during runtime (for debugging purposes), but also to dramatically reduce
 * the complexity of the code and its future maintainability.
 *
...
sap.ui.define([
    ...
    function parseExpression (sDefaultNamespace, sExpressionBody) {
        ...
        var sAllFunctionsRegExpString =
            "^(" + oFunctions.getPossibleFunctionsRegExpString() + ")[^a-z]";
    ...
    function buildExpressionRegExp () {
        ...
        var sAllFunctionsRegExpString = oFunctions.getPossibleFunctionsRegExpString();
