...
/**
 * @fileOverview URL Template Processor Resolvers
 *
 * For a given context (e.g., the reference to a site, the application section
 * from the site, parameters added during runtime...), this module can be used
 * to find the values associated to given URL Template parameter names.
 *
 * @version 1.74.0
 *
 * @private
...
sap.ui.define([
...
], function (oFunctions, oType, fnClone, oUtils) {
    "use strict";
    ...
    function resolvePipe (oParamDef, oResolvedParameters, oSite, oApplicationContext, oRuntime, sDefaultNamespace) {
        ...
        return aPipe.slice(1).reduce(function (oValues, oOperation) {
            ...
            return oFunctions.applyFunctionInPipeContext(
                oOperation.name,
        ...
        }, fnClone(oRuntime[sDefaultNamespace] || {}));
    }
    ...
    function resolveFunction (oParamDef, oResolvedParameters, oSite, oApplicationContext, oRuntime, sDefaultNamespace) {
        ...
        return oFunctions.applyFunctionInValueContext(sFunctionName, aFunctionArgs, aValues);
    }
     ...
     *
     * @param {object} oParameterSetParsed
     *   The definition of all parameter names, parsed by the URL Template
     *   parameter parser. This is, for example, an object like:
     *   <pre>{
     ...
     *     }
     *   }</pre>
     * @param {array} aResolutionOrder
     *   The order to be used while resolving individual parameters.
     * @param {object} oSite
     ...
     *   The application context. This is an object used to resolve relative
     *   paths. It's normally a subset of the site, but this is not a
     *   necessity.  It can be a completely separate object.
     *
     * @param {string} sDefaultNamespace
     *   The default namespace to use when no namespace is specified in pipe
     *   expressions.
     *
     * @returns {object}
     *   The set of parameters along with their values recovered by the respective
     *   contexts (e.g., site).
     *
     * @private
     */
