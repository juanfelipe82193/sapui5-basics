...
sap.ui.define([
    ...
    "sap/ui/core/library",
    "sap/base/Log"
], function (NumberFormat, coreLibrary, Log) {
    "use strict";
    ...
    utilsRT.getConfiguration = function (oTileApi, bAdmin, bEdit) {
        ...
        var oUtils = sap.ui.require("sap/ushell/components/tiles/utils");
    ...
    utilsRT.getTileSettingsAction = function (oModel, saveSettingsCallback, sType) {
        var utils = sap.ui.require("sap/ushell/components/tiles/utils");
        var oResourcesBundle = utils.getResourceBundleModel().getResourceBundle();
        return {
