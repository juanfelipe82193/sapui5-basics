...
sap.ui.define([
    ...
    "sap/ui/model/Filter",
    "sap/ui/model/Sorter"
], function (ODataModel, FilterOperator, Filter, Sorter) {
    "use strict";
     ...
     * A workaround is an implementation that changes the standard behavior of the API to overcome some gap or limitation in the OData provider.
