...
sap.ui.define([
    ...
    "sap/base/Log"
], function (manifestPropertyHelper, resources, formatter, JSONModel, jQuery, Log) {
    "use strict";

    sap.ui.controller("sap.ushell.components.cards.Configuration", {
        formatter: formatter,
        onInit: function () {
        ...
        _getLanguages: function () {
            ...
            return {
                ...
                logonLanguage: sap.ui.getCore().getConfiguration().getLocale().getSAPLogonLanguage(),
                ui5CoreLanguage: sap.ui.getCore().getConfiguration().getLanguage()
            };
        }
    });
});
