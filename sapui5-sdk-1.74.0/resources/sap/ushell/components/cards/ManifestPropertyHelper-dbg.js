...
sap.ui.define([
    ...
    var ManifestPropertyHelper = {
         ...
         *
         * @param {sap.ui2.srvc.Bag} bag A CHIP instance bag
         * <pre>
         ...
         *
         * @param {sap.ui2.srvc.ChipInstance} chipInstance A card CHIP instance
        ...
        _parseParameters: function (parameters) {
            var oURLService = sap.ushell.Container.getService("URLParsing"),
                oParameters = oURLService.parseParameters("?" + parameters);
