...
sap.ui.define([
    ...
    var PagingManager = BaseObject.extend("sap.ushell.components._HomepageManager.PagingManager", {
        ...
        constructor: function (sId, mSettings) {
            ...
            sap.ushell.components._HomepageManager.getPagingManager = (function (value) {
                return function () {
                    return value;
                };
            }(this.getInterface()));
         ...
         */
        getGroupHeight: function (oGroup, bFirstGroup) {
            // Implemented:
            ...
            if (!someTilesAreVisible) {
                if (oGroup.isGroupLocked || oGroup.isDefaultGroup) {
                    return 0; //don't show empty lock group or default group
                }
