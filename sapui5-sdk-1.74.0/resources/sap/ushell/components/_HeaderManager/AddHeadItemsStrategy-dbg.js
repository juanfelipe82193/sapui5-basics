...
sap.ui.define([], function () {
     ...
     *  keeping meAreaHeaderButton at the first place
    ...
    function fnAddHeaderItems ( aCurrentlyExistingItems, aIdsToAdd) {
        ...
        // Check if homBtn is part of aCurrentlyExistingItems or aIdsToAdd. If so, place it next.
        if (aCurrentlyExistingItems.indexOf("homeBtn") > -1 || aIdsToAdd.indexOf("homeBtn") > -1) {
            aNewItems.push("homeBtn");
        }
