...
sap.ui.define([
    ...
    function ElementsModel () {
        ...
        this.init = function (oConfig, oInApplicationRelatedElementsModel) {
            ...
            if (oConfig) {
                ...
                if (oConfig.moveEditHomePageActionToShellHeader) {
                    this._removeActionFromMeArea("ActionModeBtn");
                }
                if (oConfig.moveContactSupportActionToShellHeader) {
                    this._removeCustomDataActionBtnFromMeArea("ContactSupportBtn");
                }
                if (oConfig.moveGiveFeedbackActionToShellHeader) {
                    this._removeCustomDataActionBtnFromMeArea("EndUserFeedbackBtn");
                }
                if (oConfig.moveAppFinderActionToShellHeader) {
                    this._removeActionFromMeArea("openCatalogBtn");
                }
                if (oConfig.moveUserSettingsActionToShellHeader) {
                    this._removeActionFromMeArea("userSettingsBtn");
                }
        ...
        this._removeCustomDataActionBtnFromMeArea = function (btnName) {
        ...
        //The button is added to the shell header in HeaderManager
        this._removeActionFromMeArea = function (sButtonName) {
            var key;
            for (key in oBaseStates) {
                ...
                if (sButtonName === "ActionModeBtn" && key === "app") {
                    continue;
                }
                var aActions = oState.actions;
