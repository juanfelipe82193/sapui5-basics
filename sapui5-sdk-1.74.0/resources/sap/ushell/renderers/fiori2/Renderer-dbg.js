...
sap.ui.define([
    ...
    /**
     * This method MUST be called by the Unified Shell's container only, others MUST call <code>sap.ushell.Container.createRenderer("fiori2")</code>.
     *
    ...
    var Renderer = UIComponent.extend("sap.ushell.renderers.fiori2.Renderer", {
            ...
            routing: {
                ...
                routes: [
                    {
                        ...
                        target: Config.last("/core/spaces/enabled") ? "pages" : "home"
                    }, {
                        name: "appfinder",
                ...
                targets: {
                        ...
                        options: {
                            ...
                            asyncHints: {
                                preloadBundles: Config.last("/core/home/featuredGroup/enable") ?
                                    ["sap/fiori/flp-controls.js", "sap/ushell/components/homepage/cards-preload.js"] :
                    ...
                    appfinder: {
                        ...
                        options: {
                            manifest: false,
                            asyncHints: { preloadBundles: ["sap/fiori/flp-controls.js"] },
                            componentData: {
                                // use additional settings here as needed...
                                config: {
                                    enablePersonalization: true,
        ...
        init: function () {
            ...
            var fnPrepareHomepage = function () {
                //Use in ShellAnalytics to track navigation to homepage
                oEventHub.emit("trackHashChange", "Shell-home");
                if (AppConfiguration.getCurrentApplication()) {
                    sap.ushell.Container.getService("ShellNavigation").setIsInitialNavigation(false);
                }
                var sHomeTitle = resources.i18n.getText("homeBtn_tooltip");

                // switch to home first so that #set calls below have effect
                AppLifeCycle.switchViewState("home", false, "Shell-home");

                that.setCurrentCoreView("home");
            ...
            oRouter.getRoute("home").attachMatched(fnPrepareHomepage);
            oRouter.getRoute("openFLPPage").attachMatched(fnPrepareHomepage);
            ...
            oRouter.getRoute("appfinder").attachMatched(function (oEvent) {
                ...
                oEventHub.emit("trackHashChange", "Shell-appFinder");
                var oComponent = sap.ui.getCore().getComponent(that.createId("Shell-appfinder-component")),
                    oData = oEvent.getParameter("arguments");
    ...
    Renderer.prototype.createContent = function () {
        var predefineState = new UriParameters(window.location.href).get("appState") || new UriParameters(window.location.href).get("sap-ushell-config"),
            workState,
        ...
        // the code below migrates a configuration structure from version 1.28 or older, to the defaultexpected configuration structure in 1.30
        if (viewData.config) {
        ...
        flpmeasure.start(0, "Creating Shell", 0);
     ...
     * </pre>
     *
     * @param {String[]} sShellName Name of the extended shell state<br>
     * @param {function} fnCreationInstructions Contained shell api commands for creating the extension.<br>
     ...
     * </pre>
     *
     * @param {String[]} aIds List of ID elements to add to the shell.
    ...
    Renderer.prototype.showLeftPaneContent = function (aIds, bCurrentState, aStates) {
        if (bCurrentState) {
            AppLifeCycle.shellElements().addShellModelForApplications("paneContent", typeof aIds === "string" ? [aIds] : aIds);
        } else {
            this.oShellModel.addLeftPaneContent(typeof aIds === "string" ? [aIds] : aIds, false, aStates);
        }
    };
     ...
     * </pre>
     *
     * @param {String[]} aIds IDs Array of headerItem controls that should be added to the shell header<br>
     * @param {boolean} bCurrentState If <code>true</code> then the new created controls are added to the current rendered shell state.<br>
    ...
    Renderer.prototype.showHeaderItem = function (aIds, bCurrentState, aStates) {
        if (bCurrentState) {
            AppLifeCycle.shellElements().addShellModelForApplications("headItems", typeof aIds === "string" ? [aIds] : aIds);
        } else {
            this.oShellModel.addHeaderItem(typeof aIds === "string" ? [aIds] : aIds, false, aStates);
        }
    };
     ...
     * </pre>
     *
     * @param {string} sId ID of the element to add to the Tool Area.
    ...
    Renderer.prototype.showRightFloatingContainerItem = function (aIds, bCurrentState, aStates) {
        if (bCurrentState) {
            AppLifeCycle.shellElements().addShellModelForApplications("RightFloatingContainerItems", typeof aIds === "string" ? [aIds] : aIds);
        } else {
            this.oShellModel.addRightFloatingContainerItem(typeof aIds === "string" ? [aIds] : aIds, false, aStates);
        }
    };
     ...
     *   causing the items to be rendered everytime the given states are active.
    ...
    Renderer.prototype.setFooterControl = function (controlType, oControlProperties) {
        ...
        oControlInstance = this.createItem(oControlProperties, undefined, fnCreate);
        //In case a footer was created before, we remove it first before setting a new one
        if (this.lastFooterId) {
            this.removeFooter();
        }
     ...
     *   causing the items to be removed everytime the given states are active.
     * @param {String[]} aStates (only valid if bCurrentState is set to <code>false</code>) -
    ...
    Renderer.prototype.addSubHeader = function (controlType, oControlProperties, bIsVisible, bCurrentState, aStates) {
        ...
        oControlInstance = this.createItem(oControlProperties, bCurrentState, fnCreate);
        if (bIsVisible) {
            this.showSubHeader(oControlInstance.getId(), bCurrentState, aStates);
        }
        return oControlInstance;
    ...
    Renderer.prototype.addUserAction = function (oParameters) {
        var oDeferred = new jQuery.Deferred(),
            ...
            bIsVisible = oParameters.bIsVisible,
            bCurrentState = oParameters.bCurrentState,
            oModelToUpdate = bCurrentState ? AppLifeCycle.shellElements().getStateModelToUpdate() : this.oShellModel.getModelToUpdate(),
            aStates = oParameters.aStates,
     ...
     * </pre>
     *
     * @param {object} oParameters Contains the parameters that are required for creating and showing the new control object:<br>
     *  Properties:<br>
     *   - {string} controlType<br>
     *     The (class) name of the control type to create.<br>
     *   - {object} oControlProperties<br>
    ...
    Renderer.prototype.addHeaderItem = function (controlType, oControlProperties, bIsVisible, bCurrentState, aStates) {
        ...
        // the function by checking the typs of the first two arguments
        ...
        var fnCreate = function (oControlProperties) {
            ...
            oItem = this.createItem(oProperties, bCurrentState, fnCreate);
    ...
    Renderer.prototype.addRightFloatingContainerItem = function (oControlProperties, bIsVisible, bCurrentState, aStates) {
        var fnCreate = function (oControlProperties) {
            ...
            oItem = this.createItem(oControlProperties, bCurrentState, fnCreate);
     ...
     *
     * @param {string} controlType The (class) name of the control type to create.
     *   Currently only "sap.ushell.ui.shell.ShellHeadItem" control type is supported.
     * @param {object} oControlProperties The properties that will be passed to the created control.
     * @param {boolean} bIsVisible Specify whether to display the control.
     * @param {boolean} bCurrentState If true, add the current control only to the current rendered shell state.
     *   Once the user navigates to another app or back to the Home page, this control will be removed.
     ...
     * @param {boolean} bVisible specif whether to display the left pane or not
     * @since 1.30
     * @public
     */
     ...
     *
     * @param {boolean} bVisible The visiblily state of the floating container
     * @private
     */
     ...
     *
     * @param {string} sElementToCaptureSelector Element to capure selector.
     * @private
     */
     ...
     *
     * @param {boolean} bEndUserFeedbackAnonymousByDefault Indicates if the anonymous-user option is used by default in EndUserFeedback UI
     * @private
     */
     ...
     *
     * @param {boolean} bShowEndUserFeedbackLegalAgreement Indicating whether to show the legal agreement text in EndUserFeedback UI
     * @private
     */
    ...
    /*
     * Deprecated since 1.65: switchViewPortStateByControl and ViewPortContainerAttachAfterSwitchStateAnimationFinished
     */
    function noop () {
    }

    Renderer.prototype.switchViewPortStateByControl = noop;
    Renderer.prototype.ViewPortContainerAttachAfterSwitchStateAnimationFinished = noop;

    Renderer.prototype.setMeAreaSelected = function (bSelected) {
        this.shellCtrl.setMeAreaSelected(bSelected);
    };

    Renderer.prototype.getMeAreaSelected = function () {
        return this.shellCtrl.getMeAreaSelected();
    };
    ...
    Renderer.prototype.getEndUserFeedbackConfiguration = function () {
        return this.shellCtrl.oEndUserFeedbackConfiguration;
    };
