...
sap.ui.define([
    ...
    return sap.ui.core.Control.extend('sap.ushell.renderers.fiori2.search.controls.SearchFacetFilter', {
        ...
        renderer: function (oRm, oControl) {
            ...
            var createOpenFacetDialogFn = function (dimension) {
            ...
            if (oControl.getModel().getDataSource() && oControl.getModel().getDataSource().type === 'BusinessObject') {
                var hasDialogFacets = oControl.getModel().oFacetFormatter.hasDialogFacetsFromMetaData(oControl.getModel());
                if (hasDialogFacets) {
                    oRm.write("<div>");
        ...
        onAfterRendering: function () {
            ...
            //     var hasDialogFacets = this.getModel().oFacetFormatter.hasDialogFacetsFromMetaData(this.getModel());
            //     if ((this.showAllBtn && this.getFacets().length > 0) && hasDialogFacets && !this.getModel().isOtherCategory() && !this.getModel().isAllCategory() && !this.getModel().isAppCategory()) {
