...
sap.ui.define(["sap/ui/thirdparty/d3"], function () {
    "use strict";
        ...
        "sap.ushell.renderers.fiori2.search.controls.SearchFacetPieChart", {
            ...
            renderer: function (oRm, oControl) {
                ...
                PieChart.Labelposition = (function () {
                    ...
                    lp.prototype = {
                        ...
                        update: function () {
                            ...
                            if (this.debug) {
                                ...
                                this.svgBackground
                                    ...
                                    .attr(
                                        "x2",
                                        Math.sin(this.startAngle) * (this.r + this.radiusPadding)
                                    )
                                    .attr(
                                        "y2", -Math.cos(this.startAngle) * (this.r + this.radiusPadding)
                                    );
                                this.svgBackground
                                    .append("svg:line")
                                    .attr("class", "helper")
                                    ...
                                    .attr(
                                        "x2",
                                        Math.sin(this.endAngle) * (this.r + this.radiusPadding)
                                    )
                                    .attr(
                                        "y2", -Math.cos(this.endAngle) * (this.r + this.radiusPadding)
                                    );
                                this.svgBackground
                                    .append("svg:line")
                                    .attr("class", "helper")
                                    ...
                                    .attr(
                                        "y1", -Math.cos(this.startAngle) * (this.r + this.radiusPadding)
                                    )
                                    .attr(
                                        "x2",
                                        this.isStartAngleOnRight() ?
                                ...
                                this.svgBackground
                                    ...
                                    .attr(
                                        "y1", -Math.cos(this.endAngle) * (this.r + this.radiusPadding)
                                    )
                                    .attr(
                                        "x2",
                                        this.isEndAngleOnRight() ?
                                        this.backgroundWidth / 2 :
                                        -this.backgroundWidth / 2
                                    )
                                    .attr(
                        ...
                        calc: function (outset, labelWidth, labelHeight) {
                            var centroidX,
                                centroidY,
                                leftBorder,
                                rightBorder,
                                perimeterRightBorder,
                                perimeterLeftBorder;
                            /// full circle?
                            if (this.startAngle - this.endAngle + 2 * Math.PI < 1e-9) {
                                ...
                                var tmp =
                                    centroidX * Math.cos(this.startAngle) -
                                    centroidY * Math.sin(this.startAngle); //rotate by this.startAngle
                                centroidY =
                                    centroidX * Math.sin(this.startAngle) +
                                    centroidY * Math.cos(this.startAngle); //rotate by this.startAngle
                                centroidX = tmp;
                                ...
                                leftBorder = Math.max(
                                    ...
                                    this.calcLeftBorder(centroidX, lowerLabelBorder), -this.backgroundWidth / 2
                                );
                                if (
                                    Math.abs(this.startAngle - (this.endAngle % (2 * Math.PI))) >
                                    1e-9 &&
                                    centroidX > 0 &&
                                    upperLabelBorder <= 0 &&
                                    lowerLabelBorder >= 0
                                ...
                                var perimeterUpperRightBorder = this.calcPerimeterBorder(
                                    1,
                                    centroidY - this.labelHeight / 2
                                );
                                if (perimeterUpperRightBorder < centroidX) {
                                    perimeterUpperRightBorder = this.backgroundWidth / 2;
                                }
                                var perimeterLowerRightBorder = this.calcPerimeterBorder(
                                    1,
                                    centroidY + this.labelHeight / 2
                                );
                                ...
                                var perimeterUpperLeftBorder = this.calcPerimeterBorder(-1,
                                    centroidY - this.labelHeight / 2
                                );
                                if (perimeterUpperLeftBorder > centroidX) {
                                    perimeterUpperLeftBorder = -this.backgroundWidth / 2;
                                }
                                var perimeterLowerLeftBorder = this.calcPerimeterBorder(-1,
                                    centroidY + this.labelHeight / 2
                                );
                                if (perimeterLowerLeftBorder > centroidX) {
                                    perimeterLowerLeftBorder = -this.backgroundWidth / 2;
                                }
                                perimeterLeftBorder = Math.max(
                                    perimeterUpperLeftBorder,
                                    perimeterLowerLeftBorder,
                                    leftBorder
                                );
                            ...
                            labelWidth = Math.min(
                                labelWidth,
                                Math.floor(rightBorder - leftBorder)
                            );
                            // Calculate x
                            var x = centroidX;
                        ...
                        doesFitHeight: function (
                            ...
                            return (
                                upper >= Math.min(y1, y2) - 1e-9 &&
                                lower <= Math.max(y1, y2) + 1e-9
                            );
                        },
                        ...
                        calcLeftBorder: function (x, y) {
                            ...
                            if (y <= 0) {
                                ...
                                if (
                                    y >
                                    -Math.cos(this.startAngle) * (this.r + this.radiusPadding)
                                ) {
                                    // Schnittpunkt Kante mit this.startAngle im radialen (oder im horizontalen Teil)?
                                ...
                                y <
                                -Math.cos(this.endAngle) * (this.r + this.radiusPadding)
                            ) {
                        ...
                        calcPerimeterBorder: function (x, y) {
                            var border =
                                x > 0 ? this.backgroundWidth / 2 : -this.backgroundWidth / 2;
                        ...
                        isStartAngleOnRight: function () {
                            return (
                                this.startAngle > 0 &&
                                this.startAngle <= ((2 * Math.PI) / 360) * 180
                            );
                        },
                        // check wether this.endAngle on right side
                        isEndAngleOnRight: function () {
                            return (
                                this.endAngle % (2 * Math.PI) < ((2 * Math.PI) / 360) * 180
                            );
                        }
                    };
                    return lp;
                ...
                PieChart.Tweens = (function () {
                    ...
                    //======================================================================
                    Tweens1.tweenGenSimple = function (
                        d,
                        i,
                        a,
                        innerRadius,
                    ...
                    //======================================================================
                    Tweens1.tweenGenSimpleText = function (
                        d,
                        i,
                        a,
                        innerRadius,
                        ...
                        var labelpositionBefore = new PieChart.Labelposition(
                        ...
                        var coordinationBefore = [
                            labelpositionBefore.x,
                            labelpositionBefore.y
                        ];
                        var labelpositionAfter = new PieChart.Labelposition(
                            chartInstance.options.width,
                            chartInstance.options.height,
                            d.startAngle,
                            d.endAngle,
                        ...
                        if (
                            labelpositionAfter.labelWidth <
                            d.labelElement.childNodes[1].getBBox().width
                        ) {
                            chartInstance.adjustLabelWidth(
                                d.labelElement,
                                labelpositionAfter.labelWidth
                            );
                        }
                        var coordinationAfter = [
                            labelpositionAfter.x,
                            labelpositionAfter.y
                        ];
                    ...
                    Tweens1.translateStr4Padding = function (
                        startAngle,
                        endAngle,
                        padding,
                        xOldOrig,
                        ...
                        var tmp =
                            xNewOrig * Math.cos(startAngle) - yNewOrig * Math.sin(startAngle);
                        yNewOrig =
                            xNewOrig * Math.sin(startAngle) + yNewOrig * Math.cos(startAngle);
                        xNewOrig = tmp;
                        var translateStr =
                            "translate(" +
                            (xOldOrig + xNewOrig) +
                    ...
                    //======================================================================
                    Tweens1.tweenGenEcstasy = function (
                        d,
                        i,
                        a,
                        innerRadius,
                ...
                PieChart.prototype = {
                    ...
                    init: function (parentSelector, options, application, model) {
                        ...
                        this.options = {
                            ...
                            arcCalculator: PieChart.generateHistoricalArcCalculator(), //PieChart.generateDefaultArcCalculator(), PieChart.generateHistoricalArcCalculator(),
                    ...
                    notAnimatedUpdate: function (data) {
                        ...
                        // ------------------------------------------------------------------
                        // data binding
                        var sel = this.svgArcs
                            .selectAll("path")
                            .data(arcs, PieChart.getIdOfArc);
                        //remove old arcs
                        if (!sel.exit().empty()) {
                            sel.exit().remove();
                        }
                        ...
                        sel
                            ...
                            .on("click", function (d, i) {
                                ...
                                if (labelElem) {
                                    ...
                                    labelposition = new PieChart.Labelposition(
                                        that.options.width,
                                        that.options.height,
                                        d.startAngle,
                                        d.endAngle,
                                ...
                                if (d.data.selected) {
                                    ...
                                    if (that.options.oSearchFacetDialog) {
                                        ...
                                        that.options.oSearchFacetDialog.onDetailPageSelectionChangeCharts(
                                            oEvent
                                        );
                                    } else {
                                        that.model.removeFilterCondition(
                                            d.data.filterCondition,
                                            true
                                        );
                                    }
                                } else {
                        ...
                        if (!sel.empty()) {
                            sel
                                .style("opacity", function (d) {
                                    if (
                                        d.removed ||
                                        d.data.percentage < that.options.labelHideThreshold
                                    ) {
                                        return 0;
                                    }
                                    return 1;
                        ...
                        if (!sel.enter().empty()) {
                            ...
                            textsG
                                ...
                                .attr("transform", function (d) {
                                    ...
                                    var labelposition = new PieChart.Labelposition(
                                        that.options.width,
                                        that.options.height,
                                        d.startAngle,
                                        d.endAngle,
                    ...
                    adjustLabelWidth: function (element, targetWidth) {
                        ...
                        while (shadowElement.getBBox().width > targetWidth) {
                            ...
                            tmpText =
                                tmpText.substr(0, textLength - 1) +
                                tmpText.substr(textLength, 3);
                    ...
                    getArcElementtbyLabel: function (label) {
                        ...
                        that.svgArcs.selectAll("g").each(function (data, i) {
                    ...
                    getLabelElementtbyLabel: function (label) {
                        var that = this;
                        //var returnElement = null;
                        that.svgLabels.selectAll("g").each(function (data, i) {
                            if (data.data.label === label) {
                                that = this;
                            }
                        });
                ...
                //======================================================================
                PieChart.translateStr4Padding = function (
                    startAngle,
                    endAngle,
                    padding,
                    xOldOrig,
                ...
                PieChart.DefaultArcCalculator.prototype = {
                    ...
                    insertMissingArcs: function (arcs1, arcs2, ic) {
                        ...
                        for (var arc2Index = 0; arc2Index < arcs2.length; ++arc2Index) {
                            ...
                            if (arc1Index !== null) {
                                ...
                                // --------------------------------------------------------
                                if (ic) {
                                    arc1InsertIndex = this.determineInsertIndex(
                                        arcs1,
                                        arc1InsertIndex,
                                        arcs2,
                                        arc2Index
                    ...
                    determineInsertIndex: function (
                        ...
                        for (index = arc1InsertIndex + 1; index < arcs1.length; ++index) {
                            var sequenceIndex2 = this.arcSequence.getIndex(
                                arcs1[index].data.id
                            );
            ...
            getPieChartIndexByFacetIndex: function (facetIndex) {
                ...
                for (var i = 0; i < facetIndex; i++) {
                    selKey = $($(".sapUshellSearchFacetIconTabBar")[i]).find(
                        ".sapMLIBContent"
                    )[1].firstChild.id;
...
*/
                        ...
                        var percCoveredInPie = Math.round(
                            (pieChartTotal / overallTotal) * 100
                        );
                        ...
                        if (percMissing > 0) {
                            ...
                            item.tooltip = sap.ushell.resources.i18n.getText(
                                "facetPieChartOverflowText", [label]
                            );
                            item.filtered = false;
                            item.removed = false;
            ...
            getDataForPieChartLarge: function (data, model) {
                var group = [];
                var item = {};
                var itemValue = 0;
                var pieChartTotal = 0;
                ...
                if (model) {
                    ...
                    if ($(piechartParent).parent()[0].className === "sapMLIBContent") {
                        ...
                        if (that.iMissingCnt > 0) {
                            ...
                            var message = sap.ushell.resources.i18n.getText(
                                "infoZeileNumberMoreSelected", [that.iMissingCnt]
                            );
