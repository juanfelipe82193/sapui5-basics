    ...
    jQuery.extend(module, {
        ...
        getListContainersForDetailPage: function () {
            ...
            for (var i = 0; i < searchFacetLargeChartContainer.length; i++) {
                if (searchFacetLargeChartContainer[i].clientHeight > 0) { //the not ui-relevant chartContainers have height of 0
            ...
            if (chartParent) {
                ...
                var oSortButtonSet, oInputFieldForFilterTextSet, aPotentialCharts;
                ...
                aPotentialCharts = chartParent.firstChild.children;
