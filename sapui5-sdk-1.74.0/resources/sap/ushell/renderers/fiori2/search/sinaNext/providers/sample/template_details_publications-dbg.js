    ...
    return function (oContext, gen) {
        ...
        res.alligatorbook = [oContext.sina._createSearchResultSetItemAttribute({
            ...
            oContext.sina._createSearchResultSetItemAttribute({
                ...
                isHighlighted: false,
                label: 'Quote',
                value: 'Robert Daley\'s "The World Beneath The City" (1959), a history of the problems said aware to be involved in developing the network of utilities beneath Manhattan island, aware of reports that sewer inspectors first saw aligators in 1935, and confirms that their average length was about 2 feet. ',
                valueFormatted: 'Robert Daley\'s "The World Beneath The City" (1959), a history of the problems said aware to be involved in developing the network of utilities beneath Manhattan island, aware of reports that sewer inspectors first saw aligators in 1935, and confirms that their average length was about 2 feet. ',
                metadata: gen.getMetadataById(gen.metadata3, "DESC")
            }),
            oContext.sina._createSearchResultSetItemAttribute({
                id: 'FOLKLORIST',
                valueHighlighted: '',
                ...
                metadata: gen.getMetadataById(gen.metadata3, "FOLKLORIST")
            })
        ];
        ...
        res.hitchhikerbook = [oContext.sina._createSearchResultSetItemAttribute({
                id: 'PUBLICATION',
                valueHighlighted: '',
                isHighlighted: false,
                label: 'Publication',
        ...
        res.hitchhiker2book = [oContext.sina._createSearchResultSetItemAttribute({
                id: 'PUBLICATION',
                valueHighlighted: '',
                isHighlighted: false,
                label: 'Publication',
        ...
        res.babytrainbook = [oContext.sina._createSearchResultSetItemAttribute({
                id: 'PUBLICATION',
                valueHighlighted: '',
                isHighlighted: false,
                label: 'Publication',
