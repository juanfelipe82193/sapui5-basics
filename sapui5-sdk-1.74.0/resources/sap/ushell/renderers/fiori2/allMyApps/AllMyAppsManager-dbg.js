...
sap.ui.define([
...
], function (jQuery, resources, Message) {
    "use strict";
    ...
    AllMyAppsManager.prototype.loadAppsData = function (oModel, oPopoverObject, loadCatalogs) {
        ...
        if (!oAllMyAppsService.isCatalogAppsEnabled() || (oAllMyAppsService.isCatalogAppsEnabled() && loadCatalogs)) {
    ...
    AllMyAppsManager.prototype._handleGroupsData = function () {
        var that = this,
            ...
            oHomeModelEntry = { title: resources.i18n.getText("allMyApps_homeEntryTitle") },
            aProvidersArray;
        ...
        oGroupsDataPromise.done(function (oGroupsArray) {
            ...
            if (aProvidersArray) {
                var index = that._getIndexByType(aProvidersArray, oHomeModelEntry.type);
                if (index !== undefined) {
            ...
            aPromises[1].done(function (oGroupsArray) {
                for (iGroupIndex = 0; iGroupIndex < oGroupsArray.length; iGroupIndex++) {
                    ...
                    if (iNumberCustomTiles === 1) {
                        oTempNewGroup.sCustomLabel = resources.i18n.getText("allMyApps_customStringSingle");
                        oTempNewGroup.sCustomLink = resources.i18n.getText("allMyApps_customLinkHomePageSingle");
                    } else {
                        oTempNewGroup.sCustomLabel = resources.i18n.getText("allMyApps_customString", [iNumberCustomTiles]);
                        oTempNewGroup.sCustomLink = resources.i18n.getText("allMyApps_customLinkHomePage");
                    }
    ...
    AllMyAppsManager.prototype._onGetCatalogsFail = function (sMessage) {
        sap.ushell.Container.getService("Message").show(Message.Type.INFO, sMessage);
    };
