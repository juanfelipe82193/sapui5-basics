...
], function (URI, EventProvider, LocaleData) {
    "use strict";
    ...
    var User = function (oContainerAdapterConfig) {
        ...
        this.getLanguageText = function () {
            var oLocale = sap.ui.getCore().getConfiguration().getLocale(),
                ...
                oLanguageTag = sap.ui.getCore().getConfiguration().getLanguageTag();
        ...
        this.applyTheme = function (sNewTheme) {
            ...
            if (oTheme.suppliedRoot) {
                sap.ui.getCore().applyTheme(oTheme.theme, oTheme.suppliedRoot + "/UI5/");
                // the supplied path is the first choice
            } else if (oTheme.path) {
                sap.ui.getCore().applyTheme(oTheme.theme, oTheme.path + "/UI5/");
                // second choice is the ammended path
            } else {
                sap.ui.getCore().applyTheme(oTheme.theme);
