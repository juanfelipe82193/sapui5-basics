...
], function (UriParameters, UIComponent, Fiori20Adapter, coreLibrary, ServiceFactoryRegistry) {
    "use strict";
    ...
    var Fiori20AdapterConfiguration = {
        ...
        _isURLParameterSpecified: function (sParamName) {
            var oUriParameters = new UriParameters(window.location.href),
                aArr = oUriParameters.mParams && oUriParameters.mParams[sParamName];
        ...
        /*
         * The whitelist is only used for applications with minUI5Version lower than 1.38 and for applications without valid minUI5Version or valid app descriptor.
