 ...
 * <code>
 *    sap.ushell.Container.getService("AppLifeCycle").getCurrentApplication().getTechnicalParameter("sap-fiori-id");
 * </code>
 *
...
sap.ui.define([
    ...
    function getValueFromComponent (sParameterName, oApplicationComponent) {
        var aTechnicalParameters = oApplicationComponent.getComponentData().technicalParameters || {};
     ...
     *
     * @param {object} oFilterOptions The filter options are used to determine the correct technical parameterers
    ...
    function getParameters (oFilterOptions) {
        ...
        return Object.keys(oTechnicalParameters).filter(function (oTechnicalParameterName) {
            ...
            return Object.keys(oTechnicalParameters[sMatchingParameter]).reduce(function (oParameterDecription, sParameterAttributeName) {
                oParameterDecription[sParameterAttributeName] = oTechnicalParameters[sMatchingParameter][sParameterAttributeName];
                return oParameterDecription;
            }, {
