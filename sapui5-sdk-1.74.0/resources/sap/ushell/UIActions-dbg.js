...
sap.ui.define(function() {
    ...
    var UIActions = function(cfg) {
        ...
        this.draggableElement;                 // {string} Class which specifies the element that enables drag
        ...
        this.dragAndScroll = function () {
            ...
            function startAnimation() {
                ...
                style.webkitTransform = 'translate3d(0px, ' + deltaY + 'px 0px)';
                style.mozTransform = 'translate3d(0px, ' + deltaY + 'px 0px)';
                style.msTransform = 'translate3d(0px, ' + deltaY + 'px 0px)';
                style.transform = 'translate3d(0px, ' + deltaY + 'px 0px)';
            }
