...
sap.ui.define([
	 ...
	 * @private
	 */
	AxisTimeStrategyBase.prototype.fireRedrawRequest = function (bForceUpdated, sReasonCode, oValueBeforeChange, oOringinEvent) {
		this.fireEvent("_redrawRequest", {forceUpdate: bForceUpdated, reasonCode: sReasonCode, valueBeforeChange: oValueBeforeChange, originEvent: oOringinEvent});
	};
