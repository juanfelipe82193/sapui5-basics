...
sap.ui.define([
	...
	"../misc/Utility",
	"../misc/Format"
], function (library, ObjectPath, AxisTimeStrategyBase, Utility, Format) {
	"use strict";
	 ...
	 * @private
	 */
	ProportionZoomStrategy.prototype.setVisibleHorizonWithReason = function (oVisibleHorizon, sReasonCode, oOriginEvent) {
	...
	ProportionZoomStrategy.prototype.setZoomLevel = function (iZoomLevel) {
		if (iZoomLevel >= 0 && iZoomLevel !== this.getZoomLevel()) {
			...
			if (this._aZoomRate[iZoomLevel]) {
				...
				this.setVisibleHorizonWithReason(oNewVisibleHorizon, "zoomLevelChange");
			}
		}
		return this;
	};
