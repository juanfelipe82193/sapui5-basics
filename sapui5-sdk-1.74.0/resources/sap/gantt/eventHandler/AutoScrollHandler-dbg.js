...
sap.ui.define([
		...
		if ($svgCtn.offset()){
			...
			if (oEvent.pageX - iSvgLeft > 0 && oEvent.pageX - iSvgLeft < iHorizontalThreshold) {
				...
				this._iAutoScrollTimeout = jQuery.sap.intervalCall(iDelayInMillis, this, function () {
					...
					that.fireAutoScrollingEvent(oGanttChart, "scrollLeft");
				});
				return "scrollLeft";
				...
				this._iAutoScrollTimeout = jQuery.sap.intervalCall(iDelayInMillis, this, function() {
					...
					that.fireAutoScrollingEvent(oGanttChart, "scrollRight");
				});
				return "scrollRight";
				...
				this._iAutoScrollTimeout = jQuery.sap.intervalCall(iDelayInMillis, this, function() {
					...
					that.fireAutoScrollingEvent(oGanttChart, "scrollTop");
				});
				return "scrollTop";
				...
				this._iAutoScrollTimeout = jQuery.sap.intervalCall(iDelayInMillis, this, function() {
					$vsb.scrollTop($vsb.scrollTop() + iVerticalScrollStep);
					that.fireAutoScrollingEvent(oGanttChart, "scrollBottom");
				});
				return "scrollBottom";
			}
		}
	...
	AutoScrollHandler.prototype.fireAutoScrollingEvent = function(oGanttChart, sDirection){
		oGanttChart.fireEvent("_autoScrolling", {direction: sDirection});
	};
