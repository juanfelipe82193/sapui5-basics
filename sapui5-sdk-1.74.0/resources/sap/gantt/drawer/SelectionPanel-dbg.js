 ...
 */
sap.ui.define([
	"sap/gantt/drawer/Drawer", "sap/ui/core/Core", "sap/ui/core/IconPool", "sap/ui/Device",
	// 3rd party lib
	"sap/ui/thirdparty/d3"
], function (Drawer, Core, IconPool, Device) {
	"use strict";
	...
	SelectionPanel.prototype.drawSvg = function (aTableSvg, aData, iTableHeaderWidth, oGanttChartWithTable) {
		...
		if (!aTableCntPanelG.empty()) {
			var iTableWidth = jQuery(aTableSvg.node()).width();
