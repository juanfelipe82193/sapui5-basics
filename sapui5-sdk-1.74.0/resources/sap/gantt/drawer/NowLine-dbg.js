...
sap.ui.define([
	 ...
	 */
	NowLine.prototype.drawSvg = function ($GanttChartSvg, $GanttChartHeaderSvg, bTimeInUTC) {

		// Remove the line before drawing first
		this.destroySvg($GanttChartSvg, $GanttChartHeaderSvg);

		var iNowLineAxisX = this.oAxisTime.getNowLabel(bTimeInUTC)[0].value;

		var iChartWidth = jQuery($GanttChartSvg.node()).width();
		if (isNaN(iNowLineAxisX) || iNowLineAxisX > iChartWidth) {
