 ...
 */
sap.ui.define([
	"sap/gantt/shape/Shape", "sap/gantt/misc/Format"
], function (Shape, Format) {
	"use strict";
	...
	Text.prototype.getTextAnchor = function (oData) {
		var sOriginalTextAnchor = this._configFirst("textAnchor", oData);
		var bRTL = sap.ui.getCore().getConfiguration().getRTL();
		if (bRTL && (sap.ui.Device.browser.msie || sap.ui.Device.browser.edge)) {
	...
	Text.prototype.getFontFamily = function (oData) {
		return this._configFirst("fontFamily", oData, false);
	};
