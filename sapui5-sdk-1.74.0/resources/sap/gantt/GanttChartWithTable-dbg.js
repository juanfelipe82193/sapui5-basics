...
sap.ui.define([
	...
	var GanttChartWithTable = GanttChartBase.extend("sap.gantt.GanttChartWithTable", /** @lends sap.gantt.GanttChartWithTable.prototype */ {
		metadata: {
			designtime: "sap/gantt/designtime/GanttChartWithTable.designtime",
	...
	GanttChartWithTable.prototype.setNowLineInUTC = function (oValue) {
		GanttChartBase.prototype.setNowLineInUTC.call(this, oValue);
		this._oGanttChart.setNowLineInUTC(oValue);
	};
	...
	GanttChartWithTable.prototype._bindAggregation = function (sName, oBindingInfo) {
		...
		if (sName === "rows" && oBindingInfo){
			...
			this._oTT._oSelectionPlugin = this._oTC._oSelectionPlugin;
	...
	GanttChartWithTable.prototype._updateRows = function (sReason) {
		if (sReason !== "VerticalScroll" && (this._oTC.getFirstVisibleRow() === this._oTT.getFirstVisibleRow() || sReason === sap.ui.model.ChangeReason.Filter || sReason === sap.ui.model.ChangeReason.Sort)){
			Table.prototype.updateRows.apply(this._oTT, arguments);
		}
		Table.prototype.updateRows.apply(this._oTC, arguments);
	};
	...
	GanttChartWithTable.prototype._onToolbarBirdEye = function (oEvent) {
		this._oGanttChart._doBirdEye(oEvent.getParameter("birdEyeRange"));
	};
	...
	GanttChartWithTable.prototype.getVisibleWidth = function () {
		return this._oGanttChart.getVisibleWidth();
	};
	...
	GanttChartWithTable.prototype._onChartDragLeave = function (oEvent) {
		this.fireChartDragLeave({
			...
			timePopoverData: oEvent.getParameter("timePopoverData")
		});
	};
	...
	GanttChartWithTable.prototype._adjustChartHeaderHeight = function (){
		...
		var iGanttChartHeaderHeight = ($tableExtDiv ? $tableExtDiv.outerHeight() : 0) + $tableHeaderDiv.height() + 1;
	...
	GanttChartWithTable.prototype._adjustGanttInferredRowHeight = function (){
		var aHeights = this._getRowHeights();
		var iFirstVisibleRowIndex = this._getTTFirstRenderingRowIndex();
	...
	GanttChartWithTable.prototype.setTimePopoverData = function(oDraggingShape) {
		this._oGanttChart.setTimePopoverData(oDraggingShape);
	};
	...
	GanttChartWithTable.prototype._appendMaskSvg = function(){
		...
		if ($tableMask.length == 0 && this._oGanttChart.isRowExpanded()) {

			$tableMask = jQuery("<div id='" + this.getId() + "-spm-svg-table-ctn' class='sapGanttChartSPMSvgCtn' >" +
	...
	GanttChartWithTable.prototype._updateMaskSvg = function (){
		...
		$tableMask.height($tableDom.find(".sapUiTableCCnt").height());
		$tableMask.width(jQuery(document).width());
	...
	GanttChartWithTable.prototype.getLargestHorizonByDataRange = function(sBirdEyeRange, iRowIndex, bIgnoreBuffer){
		return this._oGanttChart.getLargestHorizonByDataRange(sBirdEyeRange, iRowIndex, bIgnoreBuffer);
	};
	/**
	...
	GanttChartWithTable.prototype.setSelectedIndex = function(iRowIndex) {
		this._getSelectionHandler().setSelectedIndex(iRowIndex);
		return this;
	};
	...
	GanttChartWithTable.prototype.getSelectedIndex = function() {
		return this._getSelectionHandler().getSelectedIndex();
	};
	...
	GanttChartWithTable.prototype._getTTFirstRenderingRowIndex = function () {
