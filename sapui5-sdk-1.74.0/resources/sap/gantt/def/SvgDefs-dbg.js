	...
	var SvgDefs = Element.extend("sap.gantt.def.SvgDefs", /** @lends sap.gantt.def.SvgDefs.prototype */{
		metadata: {
			...
			aggregations: {
				 ...
				 */
				defs: {type: "sap.gantt.def.DefBase", multiple: true, visibility: "public", singularName: "def", bindable: "bindable"}
			}
		}
	});
