...
sap.ui.define(['sap/chart/ChartLog', 'sap/chart/data/TimeDimension', "sap/ui/thirdparty/jquery"], function(ChartLog, TimeDimension, jQuery) {
	"use strict";
	...
	Util.dimOrMsrUse = function(oColorings, oParams, supportedType, sColoringType){
		...
		if (oParams.dimension && oParams.measure) {
			...
			if (sColoringType === 'Gradation') {
				if (jQuery.type(oParams.measure) === "Array" && oParams.measure.length > 1) {
