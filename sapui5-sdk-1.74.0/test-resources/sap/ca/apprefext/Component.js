...
sap.ui.component.load({
    name:  "i2d.qm.qualityissue.confirm.appref.Component",
    url: jQuery.sap.getModulePath("i2d.qm.qualityissue.confirm.appref")
    //no relative path as it can be deployed any where on the system
    //the shell is responsible for registering the correct paths
});
