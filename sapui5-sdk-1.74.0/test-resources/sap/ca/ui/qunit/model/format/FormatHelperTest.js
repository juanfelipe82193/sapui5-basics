window.addEventListener("load", function () {
    var oHtml = new sap.ui.core.HTML({
        content: '<div id="contentHolder"></div><h1 id="qunit-header">Fiori Wave 2: Test Page for FormatHelper</h1><h2 id="qunit-banner"></h2><h2 id="qunit-userAgent"></h2><ol id="qunit-tests"></ol>',
...
// --------------------------------------------------------------------------------
    ...
    test("options", function () {
        ...
        equal(NumberFormatter.roundNumber(12345.678901, {
            decimals: function () {
                return 1;
            }
        }), 12345.7, "roundNumber(12345.678901, {decimals:function(){return 1;}}) == 12345.7");
        equal(NumberFormatter.roundNumber(12345.678901, {
            rounding: function (x) {
                return Math.ceil(x);
            }
        }), 12346, "roundNumber(12345.678901, {rounding:function(x){return Math.ceil(x);}}) == 12346");
        equal(NumberFormatter.roundNumber(12345.678901, {
            formatStyle: "short",
            shortDecimals: 1
        }), 12345.7, "roundNumber(12345.678901, {formatStyle:'short'', shortDecimals: 1}) == 12345.7");
        equal(NumberFormatter.roundNumber(12345.678901, {
            formatStyle: "short", shortDecimals: function () {
                return 1;
            }
        }), 12345.7, "roundNumber(12345.678901, {formatStyle:'short', shortDecimals:function(){return 1;}}) == 12345.7");
        equal(NumberFormatter.roundNumber(12345.678901, {
            formatStyle: "short", shortRounding: function (x) {
                return Math.ceil(x);
            }
        }), 12346, "roundNumber(12345.678901, {formatStyle:'short', shortRounding:function(x){return Math.ceil(x);}}) == 12346");
    });
