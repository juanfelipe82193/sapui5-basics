...
//provide the fnStartSearch function for the forward dialog API
    ...
    var fnStartSearch2 = function (sQeury) {
        //do the backend request based on the sQuery text
        //...
...
//provide close function to get informed after the forward dialog has been closed
    ...
    var oBTNForward2 = new sap.m.Button({
        text: "Open Forward Dialog",
        press: function () {
            sap.ca.ui.dialog.forwarding.start(fnStartSearch2, fnForwardClose);
        }
    });
///////////
//Helpers
...
// require resourcebundle
    ...
    var oHtml = new sap.ui.core.HTML({
        content: '<div id="contentHolder"></div><h1 id="qunit-header">Fiori Wave 2: Test Page for Forward Dialog</h1><h2 id="qunit-banner"></h2><h2 id="qunit-userAgent"></h2><ol id="qunit-tests"></ol>',
    ...
    var oHorizontal = new sap.m.HBox({
        items: [oBTNForward] //defined in the forwardTest.js
    });
...
/////////////
    ...
    asyncTest("Open Dialog", function () {
        ...
        setTimeout(function () {
            //test inital focus
            var oDialog = sap.ui.getCore().byId(DIALOG_FORWARD_ID);
            ok(oDialog.getInitialFocus() === DIALOG_SEARCH_FIELD, "The initial focus is set to the search field.");
    ...
    asyncTest("Set Search Term", function () {
        testSetSearchTerm("ie", 7); //7 items in fnStartSearch
    });
    ...
    asyncTest("Set Search Term", function () {
        testSetSearchTerm("Manager", 5); //5 items in fnStartSearch2
    });
