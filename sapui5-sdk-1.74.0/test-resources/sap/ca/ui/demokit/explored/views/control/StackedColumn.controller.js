...
sap.ui.controller("sap.ca.ui.sample.views.control.StackedColumn", {
    ...
    pressLegendButton: function(oEvent) {
	    this.getView().byId('scChart').setShowLegend(oEvent.getParameters().selected);
	    this.getView().byId('dscChart').setShowLegend(oEvent.getParameters().selected);
	    this.getView().byId('sc100Chart').setShowLegend(oEvent.getParameters().selected);
	    this.getView().byId('dsc100Chart').setShowLegend(oEvent.getParameters().selected);
	},
