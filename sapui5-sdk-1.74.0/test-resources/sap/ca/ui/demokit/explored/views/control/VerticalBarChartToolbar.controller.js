...
sap.ui.controller("sap.ca.ui.sample.views.control.VerticalBarChartToolbar", {
    ...
    measures1:new sap.viz.ui5.data.MeasureDefinition('VBTB_Profit', {
        name:'Profit',
        value:'{PROFIT}'
    }),
    measures2:new sap.viz.ui5.data.MeasureDefinition('VBTB_Revenue', {
        name:'Revenue',
        value:'{REVENUE}'
    }),
    measures3:new sap.viz.ui5.data.MeasureDefinition('VBTB_Population', {
        name:'Population',
        value:'{POPULATION}'
    }),
    ...
    onInit:function () {
        ...
        this.chart = this.byId("fioriVerticalBarChartToolbar");
    ...
    createData:function () {
        ...
        if (!!params && !!params["count"]) {
            ...
            jQuery.sap.log.info("Count parameter detected: " + count);
        }
        switch (e) {
            case 1:
                for (i = 0; i < count; i++) {
