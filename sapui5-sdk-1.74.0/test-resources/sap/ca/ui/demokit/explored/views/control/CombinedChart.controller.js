sap.ui.controller("sap.ca.ui.sample.views.control.CombinedChart", {
    ...
    pressSwitchButton:function(oEvent) {
        ...
        if (this.isMultiSelection) {
            this.oCombined.setSelectionMode(sap.ca.ui.charts.ChartSelectionMode.Multiple);
        } else {
            this.oCombined.setSelectionMode(sap.ca.ui.charts.ChartSelectionMode.Single);
        }
    }
