...
sap.ui.controller("sap.ca.ui.sample.views.control.VerticalBarChart", {
  ...
  measures1: new sap.viz.ui5.data.MeasureDefinition('Profit', {
    name: 'Profit',
    value: '{PROFIT}'
  }),
  measures2: new sap.viz.ui5.data.MeasureDefinition('Revenue', {
    name: 'Revenue',
    value: '{REVENUE}'
  }),
  measures3: new sap.viz.ui5.data.MeasureDefinition('Population', {
    name: 'Population',
    value: '{POPULATION}'
  }),
  ...
  onInit: function() {
    ...
    util.UiFactory.fillPageHeader(page, this.getView(), util.Title.VERTICAL_BAR_CHART);

    this.chart = this.byId("fvbChart");
