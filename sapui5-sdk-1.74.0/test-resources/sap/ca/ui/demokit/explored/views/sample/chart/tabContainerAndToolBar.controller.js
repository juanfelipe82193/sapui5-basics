sap.ui.controller("views.sample.chart.tabContainerAndToolBar", {
    ...
    onInit : function() {
        ...
        this.oCombined6 = this.byId("fioriCombinedChartInsideToolBar6");
        this.oCombined7 = this.byId("fioriCombinedChartInsideToolBar7");
        this.oCombined8 = this.byId("fioriCombinedChartInsideToolBar8");
        ...
        var oModel6 = this.internalTestModel();
        var oDataset6 = this.internalTestDataset(oModel6);

        this.oCombined6.setDataset(oDataset6);

        var oModel7 = this.internalTestModel();
        var oDataset7 = this.internalTestDataset(oModel7);

        this.oCombined7.setDataset(oDataset7);

        var oModel8 = this.internalTestModel();
        var oDataset8 = this.internalTestDataset(oModel8);

        this.oCombined8.setDataset(oDataset8);
