...
sap.ui.controller("sap.ca.ui.sample.views.control.HorizontalBarChartToolbar", {
  ...
  measures1: new sap.viz.ui5.data.MeasureDefinition('HBT_Profit', {
    name: 'Profit',
    value: '{PROFIT}'
  }),
  measures2: new sap.viz.ui5.data.MeasureDefinition('HBT_Revenue', {
    name: 'Revenue',
    value: '{REVENUE}'
  }),
  measures3: new sap.viz.ui5.data.MeasureDefinition('HBT_Population', {
    name: 'Population',
    value: '{POPULATION}'
  }),
  ...
  onInit: function() {
    ...
    this.chart = this.byId("fioriHorizontalBarChartToolbar");
