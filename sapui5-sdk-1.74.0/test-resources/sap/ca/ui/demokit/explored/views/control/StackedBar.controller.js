...
sap.ui.controller("sap.ca.ui.sample.views.control.StackedBar", {
	...
	pressLegendButton: function(oEvent) {
	    this.getView().byId('sbChart').setShowLegend(oEvent.getParameters().selected);
	    this.getView().byId('dsbChart').setShowLegend(oEvent.getParameters().selected);
	    this.getView().byId('sb100Chart').setShowLegend(oEvent.getParameters().selected);
	    this.getView().byId('dsb100Chart').setShowLegend(oEvent.getParameters().selected);
	},
