...
sap.ui.controller("sap.ca.ui.sample.views.control.CustomerContext", {
    ...
    onInit: function () {
        ...
        util.UiFactory.fillPageHeader(page, this.getView(), util.Title.CUSTOMER_CONTEXT, "sap.ca.ui.CustomerContext");
        ...
        var oData = {
            CustomerCollection: [
                { CustomerName: "Becker Berlin", CustomerNo: "0000500098", SalesOrganizationName: "IDES", DistributionChannelName: "IDES America", DivisionName: "Local Distributors" },
                { CustomerName: "Clinton Industries", CustomerNo: "0000300701", SalesOrganizationName: "AMID", DistributionChannelName: "AMID Europe", DivisionName: "Central shipment" },
                { CustomerName: "JNM Manufacturing", CustomerNo: "JPMO002", SalesOrganizationName: "CGU", DistributionChannelName: "CGU Asia", DivisionName: "Local Distributors" },
                { CustomerName: "Jupp Schmitz & Soehne", CustomerNo: "0000500060", SalesOrganizationName: "IDES", DistributionChannelName: "IDES Australia", DivisionName: "Central shipment" }
            ]
        };
    ...
    onCustomerSelected: function (oEvent) {
        ...
        if (oCustomer.CustomerNo) {
            oSettings.message = 'new customer selected: ' + oCustomer.CustomerName2;
