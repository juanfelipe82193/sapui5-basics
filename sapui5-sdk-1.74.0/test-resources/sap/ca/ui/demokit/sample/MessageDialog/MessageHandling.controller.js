...
sap.ui.controller("sap.ca.ui.sample.MessageDialog.MessageHandling", {
    onInit:function () {
    },
    ...
    onAdditionalStyle :  function(e) {
    var oMessage = sap.ca.ui.message.showMessageBox({
        type: sap.ca.ui.message.Type.SUCCESS,
        message: "   You may need to use Message Toast\n",
        details: "You may need to use Message Toast\n"
    });
    //how to apply styleclass for compact mode
    oMessage.addStyleClass("testClass");
}
})
;
