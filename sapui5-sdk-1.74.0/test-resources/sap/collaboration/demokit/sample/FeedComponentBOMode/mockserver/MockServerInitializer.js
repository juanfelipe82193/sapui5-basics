		...
		this._mockServerInitializationData = {
			jam: {
				...
				aRequestData: [ // This array defines addition responses the mock server must provide.
					...
					['GET', /FeedEntries.*ktRtJ1iyYfYMBqV9T4NEMa.*Replies.*/, 'respondFile', 200, null, sMockServerDataFolderPath + 'jamodata/Replies.json'],
					['GET', /FeedEntries.*HWKtQGWgPFKcRkN6K8mNo2.*Replies.*/, 'respondFile', 200, null, sMockServerDataFolderPath + 'jamodata/Replies2.json'],
					['GET', /FeedEntries.*0OragrE05zVRBjCyFwydIu.*Replies.*/, 'respondFile', 200, null, sMockServerDataFolderPath + 'jamodata/Replies3.json'],
					['GET', /FeedEntries.*hHhLSLqzAIiakKzFmBQEGr.*Replies.*/, 'respondFile', 200, null, sMockServerDataFolderPath + 'jamodata/Replies4.json'],
					...
					['GET', /ExternalObjects.*Groups.*/, 'respondFile', 200, null, sMockServerDataFolderPath + 'jamodata/Groups.json'],
					...
					['GET', /GroupExternalObjects.*FeedEntries.*/, 'respondFile', 200, null, sMockServerDataFolderPath + 'jamodata/FeedEntries2.json'],
					['POST', /GroupExternalObjects.*FeedEntries/, 'respondFile', 200, null, sMockServerDataFolderPath + 'jamodata/AddPost.json'],
			...
			smi: {
				...
				mockServerSimulateFunctionArguments: [
					...
					{
						sMockdataBaseUrl: sMockServerDataFolderPath + 'smiodata/', // This is the path to the folder where the responses are stored.
						bGenerateMissingMockData: false // This tells the mock server not to respond with its own data for non-defined responses.
					}
				],
				aRequestData: [
