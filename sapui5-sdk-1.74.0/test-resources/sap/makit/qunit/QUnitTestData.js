sap.ui.define(["sap/ui/model/json/JSONModel"], function(JSONModel) {
	...
	function getCombiChartMSDataModel() {
		...
		var MSTestData = {mydata : testdata}; // TODO export needed?
	...
	return {
		getMultiSeriesJSONDataModel: getMultiSeriesJSONDataModel,
		getSingleSeriesJSONDataModel: getSingleSeriesJSONDataModel,
		getPieRevenueDataModel: getPieRevenueDataModel,
		getCombiChartMSDataModel: getCombiChartMSDataModel,
		displayLog: displayLog,
		displayPerformance: displayPerformance,
		beforeSetDataTable: beforeSetDataTable	
	};
});