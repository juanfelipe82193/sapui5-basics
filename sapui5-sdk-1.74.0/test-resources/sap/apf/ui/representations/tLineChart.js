...
sap.ui.define("sap/apf/ui/representations/tLineChart", [
	...
	"sap/viz/ui5/controls/VizFrame"
			...
			LineChart, HorizontalLayout, VizFrame) {
	"use strict";
	...
	function _commonSetupForCreatingChart(api, requiredParameter) {
		...
		var chart = new LineChart(interfaceProxy, requiredParameter);
	...
	BaseVizFrameChartRepresentationTestHelper.run(LineChart);
	...
	QUnit.test("When Line Chart is initialized", function(assert) {
		//assert
	...
	QUnit.test("When Line Chart is initialized with multiple parameters", function(assert) {
		//arrange
