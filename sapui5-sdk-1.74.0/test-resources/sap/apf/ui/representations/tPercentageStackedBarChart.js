...
sap.ui.define("sap/apf/ui/representations/tPercentageStackedBarChart", [
	...
	"sap/apf/ui/representations/percentageStackedBarChart",
	...
	"sap/viz/ui5/controls/VizFrame"
			...
			PercentageStackedBarChart, HorizontalLayout, VizFrame) {
	"use strict";
	...
	function _commonSetupForCreatingChart(api, requiredParameter) {
		...
		var chart = new PercentageStackedBarChart(interfaceProxy, requiredParameter);
	...
	BaseVizFrameChartRepresentationTestHelper.run(PercentageStackedBarChart);
	...
	QUnit.module("Percentage Stacked Bar Chart Tests - Interaction on charts based on required property", {
		beforeEach : function(assert) {
			var testEnv = this;
			var done = assert.async();
