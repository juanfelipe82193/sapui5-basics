...
sap.ui.define("sap/apf/ui/representations/tColumnChart", [
	...
	"sap/viz/ui5/controls/VizFrame"
			...
			ColumnChart, HorizontalLayout, VizFrame) {
	"use strict";
	...
	function _commonSetupForCreatingChart(api, requiredParameter) {
		...
		var chart = new ColumnChart(interfaceProxy, requiredParameter);
	...
	BaseVizFrameChartRepresentationTestHelper.run(ColumnChart);
	...
	QUnit.test("When Column Chart is initialized", function(assert) {
		//assert
	...
	QUnit.test("When Column Chart is initialized with multiple parameters", function(assert) {
		//arrange
