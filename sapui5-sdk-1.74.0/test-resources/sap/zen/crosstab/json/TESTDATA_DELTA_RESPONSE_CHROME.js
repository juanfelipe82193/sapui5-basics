...
sapzen.crosstab.test.jsonTestData.TESTDATA_DELTA_RESPONSE_CHROME = {
		"control" : {
			"type" : "xtable",
					...
					"row" : {
						...
						"cells" : [{
								...
								"control" : {
									...
									"level" : 0,
									"drillstate" : "O",
									"hierarchyaction" : "sapbi_page.sendCommandArrayWoEventWoPVT([['BI_COMMAND',null,0,[['GUID','97',0],['BI_COMMAND_TYPE','ABSTRACT',0]]]]);",
									"hierarchytooltip" : "",
									"key" : "CATEGORY",
								...
								"control" : {
									...
									"level" : 1,
									"drillstate" : "C",
									"hierarchyaction" : "sapbi_page.sendCommandArrayWoEventWoPVT([['BI_COMMAND',null,0,[['GUID','99',0],['BI_COMMAND_TYPE','ABSTRACT',0]]]]);",
									"hierarchytooltip" : "",
									"key" : "MEDIUM_1",
									"style" : "HIERARCHY_LEVEL2",
									"_v" : "MEDIUM_1"
