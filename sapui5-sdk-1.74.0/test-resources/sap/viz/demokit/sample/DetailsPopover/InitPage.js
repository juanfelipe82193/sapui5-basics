    ...
    return {
        initPageSettings : function(oView) {
            ...
            if (bSuiteAvailable) {
                ...
                oView.byId('chartFixFlex').insertFixContent(new sap.m.MessageStrip({
                    text: 'Failed to load "sap.suite.ui.commons" for the display of details popover. It is available in sapui5-sdk-dist version only.',
                    type: "Information",
                    showIcon: true
                    })
                );
