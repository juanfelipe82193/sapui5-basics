...
var a1m1m2m3m3m3Model = {
  data:[
    { Country : "Canada", profit: 10, target: 10, refer1: 5, refer2: 8, refer3: 10},
    { Country : "China",profit: 18, target: 8, refer1: 3, refer2: 4, refer3: 5},
    { Country : "France",profit: 13, target: 15, refer1: 6, refer2: 8, refer3:  15},
    { Country : "Germany",profit: 14, target: 20, refer1: 6, refer2: 8, refer3: 15},
    { Country : "India",profit: 8, target: 16, refer1: 4, refer2: 8, refer3: 16},
    { Country : "United States",profit: 20, target: 22, refer1: 8, refer2: 12, refer3: 20}
  ]
};

var a1m1m2m3m3m3Data = {
    dimensions : [ 
        { axis : 1, name : 'Country', value : "{Country}"}
    ],
    measures : [ 
...
var getDataset = function(dataType) {
  ...
  case 'a1m1_nullMname':
    ...
    break;
  case 'a1m1m2m3m3m3' : 
    oModel = new sap.ui.model.json.JSONModel(a1m1m2m3m3m3Model);
    dataJSON = a1m1m2m3m3m3Data;
  }
...
var simpleDeepEquals = function(data1, data2, statement) {
  QUnit.assert.equal( JSON.stringify(data1.analysisAxis), JSON.stringify(data2.analysisAxis), "analysisAxis: " + statement);
  QUnit.assert.equal( JSON.stringify(data1.measureValuesGroup), JSON.stringify(data2.measureValuesGroup), "measureValuesGroup: " + statement);
};
