sap.ui.require([
			    ...
			    var sRulePath = "/Rules('005056912EC51ED689E4A0446983C440')";
			    Opa5.extendConfig({
			    ...
			    opaTest("Should measure reading RuleBuilder data and openning setting", function (Given, When, Then) {
			        ...
			        //Actions
			        When.onThePerformanceTestPage.iCanSeeTheRuleBuilderWithData("and When: RuleBuilder has completed read data", "myRuleBuilder", sViewName, sRulePath, "250_2_2", 10);
                    Then.onThePerformanceTestPage.iCheckNumOfRowsForPerformance("Then: DT have 250 row", "myRuleBuilder", "249", sRulePath, sViewName, true);
			    ...
			    opaTest("Should measure add row", function (Given, When, Then) {
			        ...
			        Then.onThePerformanceTestPage.iCheckNumOfRowsForPerformance("Then: DT have 1 row", "myRuleBuilder", "250", sRulePath, sViewName);
			    });
			    opaTest("Should measure delete row", function (Given, When, Then) {
			        ...
			        iCheckNumOfRowsForPerformance("Then: DT have 249 row", "myRuleBuilder", "249", sRulePath, sViewName).and.
