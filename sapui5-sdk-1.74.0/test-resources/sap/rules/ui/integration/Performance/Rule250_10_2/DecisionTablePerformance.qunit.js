sap.ui.require([
			    ...
			    var sRulePath = "/Rules('005056912EC51EE689DE232F0ACE8F38')";
			    Opa5.extendConfig({
			    ...
			    opaTest("Should measure reading RuleBuilder data and openning setting", function (Given, When, Then) {
			        ...
			        //Actions
			        When.onThePerformanceTestPage.iCanSeeTheRuleBuilderWithData("and When: RuleBuilder has completed read data", "myRuleBuilder", sViewName, sRulePath, "250_10_2", 10);
                    Then.onThePerformanceTestPage.iCheckNumOfRowsForPerformance("Then: DT have 250 row", "myRuleBuilder", "250", sRulePath, sViewName, true);
			    ...
			    opaTest("Should measure insert column", function (Given, When, Then) {
			        ...
			        //Actions
			        When.onThePerformanceTestPage.iClickTheAddRemoveButton("When: Add new column to setting table", "sap.ui.layout.HorizontalLayout", 9, 1, sViewName, true);
			        Then.onThePerformanceTestPage.iCheckSettingNoBusy("and Then: Setting isn't Busy", sViewName, false, true);
			        // Assertions
			        Then.onThePerformanceTestPage.iCheckNumOfCols("Then: DT have 11 row", "sap.m.Table", "11", sViewName, sRulePath, true);
			    });
			    opaTest("Should measure delete column", function (Given, When, Then) {

			        //Actions
			        When.onThePerformanceTestPage.iClickTheAddRemoveButton("When: Add delete column to setting table", "sap.ui.layout.HorizontalLayout", 10, 0, sViewName, true);

			        //Assertions
			        Then.onThePerformanceTestPage.iCheckNumOfCols("Then: DT have 10 columns", "sap.m.Table", "10", sViewName, sRulePath, false, false);
			    ...
			    opaTest("Should measure add row", function (Given, When, Then) {
			        ...
			        Then.onThePerformanceTestPage.iCheckNumOfRowsForPerformance("Then: DT have 251 row", "myRuleBuilder", "251", sRulePath, sViewName);
			    });
			    opaTest("Should measure delete row", function (Given, When, Then) {
			        ...
			        iCheckNumOfRowsForPerformance("Then: DT have 250 row", "myRuleBuilder", "250", sRulePath, sViewName).and.
