sap.ui.require([
			    ...
			    var sRulePath = "/Rules('005056912EC51EE695E00FA54FFA3CFA')";
			    Opa5.extendConfig({
			    ...
			    opaTest("Should measure reading RuleBuilder data and openning setting", function (Given, When, Then) {
			        ...
			        //Actions
			        When.onThePerformanceTestPage.iCanSeeTheRuleBuilderWithData("and When: RuleBuilder has completed read data", "myRuleBuilder", sViewName, sRulePath, "500_2_2", 10);
                    Then.onThePerformanceTestPage.iCheckNumOfRowsForPerformance("Then: DT have 500 row", "myRuleBuilder", "499", sRulePath, sViewName, true);
			    ...
			    opaTest("Should measure add row", function (Given, When, Then) {
			        ...
			        Then.onThePerformanceTestPage.iCheckNumOfRowsForPerformance("Then: DT have 500 row", "myRuleBuilder", "500", sRulePath, sViewName);
			    });
			    opaTest("Should measure delete row", function (Given, When, Then) {
			        ...
			        iCheckNumOfRowsForPerformance("Then: DT have 499 row", "myRuleBuilder", "499", sRulePath, sViewName).and.
