sap.ui.require([
			    ...
			    var sRulePath = "/Rules('005056912EC51EE695DDA02BE74F7285')";
			    Opa5.extendConfig({
			    ...
			    opaTest("Should measure reading RuleBuilder data and openning setting", function (Given, When, Then) {
			        ...
			        //Actions
			        When.onThePerformanceTestPage.iCanSeeTheRuleBuilderWithData("and When: RuleBuilder has completed read data", "myRuleBuilder", sViewName, sRulePath, "2_2_2", 2);
                    Then.onThePerformanceTestPage.iCheckNumOfRowsForPerformance("Then: DT have 2 row", "myRuleBuilder", "2", sRulePath, sViewName, true);
			    ...
			    opaTest("Should measure add row", function (Given, When, Then) {
			        ...
			        Then.onThePerformanceTestPage.iCheckNumOfRowsForPerformance("Then: DT have 3 row", "myRuleBuilder", "3", sRulePath, sViewName);
			    });
			    opaTest("Should measure delete row", function (Given, When, Then) {
			        ...
			        iCheckNumOfRowsForPerformance("Then: DT have 2 row", "myRuleBuilder", "2", sRulePath, sViewName).and.
