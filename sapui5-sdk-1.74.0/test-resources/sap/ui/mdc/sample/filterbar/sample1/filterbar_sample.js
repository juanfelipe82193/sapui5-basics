sap.ui.require(["sap/ui/core/ComponentContainer", "sap/ui/mdc/sample/filterbar/sample1/ViewFactory", "sap/ui/model/odata/v4/ODataModel", "sap/ui/model/odata/OperationMode"],
		...
		sap.ui.require([
			...
			oMockServer.started.then(function() {
				...
				new ComponentContainer("TestContainer", {
					name: "sap.ui.mdc.sample.filterbar.sample1",
					settings: {
