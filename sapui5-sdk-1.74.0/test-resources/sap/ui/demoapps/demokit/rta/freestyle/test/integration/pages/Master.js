			...
			assertions: {
				...
				theListHeaderDisplaysZeroHits: function() {
					return this.waitFor({
						...
						success: function() {
							QUnit.ok(true, "The list header displays 'SEPMRA_C_PD_Product (0)'");
						},
				...
				iShouldSeeTheNoDataTextForNoSearchResults: function() {
					return this.waitFor({
						...
						viewName: sViewName,
						success: function(oList) {
							QUnit.strictEqual(oList.getNoDataText(), oList.getModel("i18n").getProperty("No matching products found"),
