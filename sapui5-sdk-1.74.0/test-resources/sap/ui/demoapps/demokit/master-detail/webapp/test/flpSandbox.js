					...
					"config": {
						"inbounds": {
							"MasterDetail-display": {
								...
								"action": "display",
								"description": "A template for Master-Detail applications",
								"title": "Master-Detail",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.demo.masterdetail",
									"url": sap.ui.require.toUrl("sap/ui/demo/masterdetail")
								}
							}
						}
					}
