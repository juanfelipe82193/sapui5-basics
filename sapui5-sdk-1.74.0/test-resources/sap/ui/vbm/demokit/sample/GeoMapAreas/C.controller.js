sap.ui.define([
	...
	sap.ui.controller("sap.ui.vbm.sample.GeoMapAreas.C", {
	
		onInit : function () {
		    var oModel = new sap.ui.model.json.JSONModel("test-resources/sap/ui/vbm/demokit/sample/GeoMapAreas/Data.json");
