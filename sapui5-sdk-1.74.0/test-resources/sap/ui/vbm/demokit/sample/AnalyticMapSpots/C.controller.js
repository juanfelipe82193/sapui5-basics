sap.ui.define([
	...
	sap.ui.controller("sap.ui.vbm.sample.AnalyticMapSpots.C", {

		onInit: function() {
			var oModel = new sap.ui.model.json.JSONModel("test-resources/sap/ui/vbm/demokit/sample/AnalyticMapSpots/Data.json");
