sap.ui.require([
	"sap/m/Shell", "sap/ui/core/ComponentContainer", "sap/ui/core/util/MockServer",'sap/ui/fl/FakeLrepConnectorLocalStorage'
	...
	new Shell("myShell", {
		app: new ComponentContainer({
			...
			component: sap.ui.component({
				name: "test.sap.ui.comp.smartchart.exampleFilterbarLazyLoad",
				id: "myComponent"
			})
		})
	}).placeAt("content");
