sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartmultiinput.withoutBinding.Component", {
		metadata: {
			rootView: {
				"viewName": "sap.ui.comp.sample.smartmultiinput.withoutBinding.SmartMultiInput",
				"type": "XML",
				"async": true
			},
			dependencies: {
