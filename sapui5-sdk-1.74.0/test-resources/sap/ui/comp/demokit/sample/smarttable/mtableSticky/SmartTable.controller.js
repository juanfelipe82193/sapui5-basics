sap.ui.define([
	...
	return Controller.extend("sap.ui.comp.sample.smarttable.mtableSticky.SmartTable", {
		onInit: function () {
			var oModel, oView;
			var oMockServer = new MockServer({
				rootUri: "sapuicompsmarttableSticky/"
			});
			...
			oMockServer.start();
			oModel = new ODataModel("sapuicompsmarttableSticky", {
