sap.ui.define([
	...
	return UIComponent.extend("sap.ui.comp.sample.smartfilterbar.FiscalDates.Component", {

		_oMockServer: null,

		metadata: {
			rootView: {
			 "viewName": "sap.ui.comp.sample.smartfilterbar.FiscalDates.SmartFilterBar",
			   "type": "XML",
			  "async": true
			},
			dependencies: {
