...
sap.ui.require([
	...
	opaTest("When I load 'Compatibility01' variant, some table characteristics should be changed", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Compatibility01");

		// Assertions
		Then.iShouldSeeColumnOfWidth("Product Name", "161px");
		Then.iShouldSeeTableWithFixedColumnCount(1);
	});

	opaTest("When I change to the 'Standard' variant, the initial table should appear", function(Given, When, Then) {
		//Actions
		When.iSelectVariant("Standard");

		// Assertions
		Then.iShouldSeeColumnOfWidth("Product Name", "30em");
		Then.iShouldSeeTableWithFixedColumnCount(0);
	});
