sap.ui.define(['sap/m/MessageToast', 'sap/ui/core/mvc/Controller', 'sap/ui/model/json/JSONModel'],
	...
	var PageController = Controller.extend("sap.suite.ui.microchart.sample.RadialMicroChartResponsive.Page", {
		...
		press: function (oEvent) {
			MessageToast.show("The RadialMicroChart is pressed.");
		},
		onLarge: function() {
		...
		onBorderSwitch: function(oEvent) {
			...
			if (bState) {
				oContainer.$().css("border", "1px dotted #c5c5c5");
