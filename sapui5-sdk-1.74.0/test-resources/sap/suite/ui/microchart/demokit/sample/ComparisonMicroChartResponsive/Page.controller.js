sap.ui.define([
	...
	function (MessageToast, Controller, JSONModel, MicrochartsLibrary) {
		...
		var ComparisonMicroChartViewType = MicrochartsLibrary.ComparisonMicroChartViewType;
		...
		var PageController = Controller.extend("sap.suite.ui.microchart.sample.ComparisonMicroChartResponsive.Page", {
			...
			onWide: function() {
				this.oModel.setProperty("/width", 200);
			...
			onViewTypeChange: function (oEvent) {
				var oChart = this.byId("comparisonChart");

				switch (oEvent.getParameter("selectedIndex")) {
					default:
					case 0:
						oChart.setView(ComparisonMicroChartViewType.Normal);
						break;
					case 1:
						oChart.setView(ComparisonMicroChartViewType.Wide);
						break;
					case 2:
						oChart.setView(ComparisonMicroChartViewType.Responsive);
						break;
				}
			},
