	...
	function (PropertyStrictEquals, AggregationFilled, Press) {
		...
		return function (prefix, viewName, viewNamespace) {
			...
			return {
				...
				iShouldChangeTheInputText: function() {
					return this.waitFor({
						controlType: "sap.m.Input",
						success: function(control) {
                                                 	var sPath = "UpdatePath";
							control[0].setValue(sPath);
						},
						errorMessage: "The input field couldn't be updated."
					});
				},

				iClickTheButtonInCanvas: function (buttonText) {
					console.log ( "OPA5::ObjectPageActions::iClickTheButton" + " buttonText: " + buttonText + " viewName: " + viewName + " viewNamespace " + viewNamespace);
					return this.waitFor({
						controlType: "sap.m.Button",
						matchers: [
				...
				iClickTheItemTabFilterInCanvas: function (buttonText) {
					console.log ( "OPA5::ObjectPageActions::iClickTheItemTabFilterInCanvas" + " buttonText: " + buttonText + " viewName: " + viewName + " viewNamespace " + viewNamespace);
					return this.waitFor({
						...
						actions: new Press(),
						errorMessage: "The Icon Tab Filter cannot be clicked"
					});
				},
				
				iChangeTheSelectedItemInSelectControl: function (sNewSelectedItem) {
					return this.waitFor({
						controlType: "sap.m.Select",
						viewName: viewName,
						viewNamespace: viewNamespace,
						success: function(oControl) {
							sActualSelectedItem = oControl[0].setSelectedKey(sNewSelectedItem);
						},
						errorMessage: "The Control sap.m.Select is NOT rendered correctly or the expected item "+sNewSelectedItem+" is not selected"
					});
				}
			};
		};
