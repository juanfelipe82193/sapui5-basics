sap.ui.define(['sap/ui/test/Opa5',
               ...
               "sap/suite/ui/generic/template/integration/SalesOrderWorklist/utils/OpaDataStore",
               "sap/ui/test/actions/Press"],
	function(Opa5, AggregationFilled, OpaDataStore, Press) {
		"use strict";

		return Opa5.extend("sap.suite.ui.generic.template.opa.SalesOrderWorklist.pages.Common", {

			iStartTheListReport: function(oOptions) {
				var opaFrame = "test-resources/sap/suite/ui/generic/template/demokit/demokit.html?serverDelay=0&responderOn=true&demoApp=sttasalesorderwklt&sap-ui-language=en_US";
			...
			iStartTheObjectPage: function(oOptions) {
				var opaFrame = "test-resources/sap/suite/ui/generic/template/demokit/demokit.html?serverDelay=0&responderOn=true&sap-ui-language=en_US&demoApp=sttasalessorderwklt#/C_STTA_SalesOrder_WD_20(SalesOrder='500000000',DraftUUID=guid'00505691-115b-1ee6-b7af-2c76b881888d',IsActiveEntity=false)"
