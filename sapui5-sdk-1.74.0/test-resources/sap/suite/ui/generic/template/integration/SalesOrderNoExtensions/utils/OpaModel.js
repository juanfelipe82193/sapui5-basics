sap.ui.define(["sap/ui/core/util/MockServer", "sap/ui/model/odata/v2/ODataModel"],
	function (MockServer, ODataModel) {
		...
		var getMockModel = function() {
			...
			oMockServer.simulate("test-resources/sap/suite/ui/generic/template/demokit/sample.stta.sales.order.no.extensions/webapp/localService/metadata.xml", {
				sMockdataBaseUrl: "test-resources/sap/suite/ui/generic/template/demokit/sample.stta.sales.order.no.extensions/webapp/localService/",
			...
			oModel = new ODataModel("/sap/opu/odata/sap/STTA_SALES_ORDER_WD_20_SRV/", {
				...
				annotationURI: [
					"test-resources/sap/suite/ui/generic/template/demokit/sample.stta.sales.order.no.extensions/webapp/localService/STTA_SALES_ORDER_WD_20_ANNO_MDL.xml",
					"test-resources/sap/suite/ui/generic/template/demokit/sample.stta.sales.order.no.extensions/webapp/annotations/annotations.xml"
				]
			});
