sap.ui.define(['sap/ui/test/Opa5',
	...
	function(Opa5, AggregationFilled, OpaDataStore, Press) {
		...
		return Opa5.extend("sap.suite.ui.generic.template.opa.SalesOrderSegButtons.pages.Common", {
		
			iStartTheListReport: function(oOptions) {
				var opaFrame = "test-resources/sap/suite/ui/generic/template/demokit/demokit.html?serverDelay=0&responderOn=true&demoApp=sttasalesordersb&sap-ui-language=en_US";
				if (oOptions && oOptions.manifest){
					opaFrame =  opaFrame + "&manifest=manifest" + oOptions.manifest;
				}
				else if(oOptions && !oOptions.manifest){
			...
			iStartMyApp: function(opaFrame) {
				console.log("OPA5::Common.js::iStartMyApp" + " opaFrame: " + opaFrame);
				return this.iStartMyAppInAFrame(opaFrame);
			},

			iStartTheObjectPage: function(oOptions) {
				var opaFrame = "test-resources/sap/suite/ui/generic/template/demokit/demokit.html?serverDelay=0&responderOn=true&sap-ui-language=en_US&demoApp=sttasalesordersb#/C_STTA_SalesOrder_WD_20(SalesOrder='500000000',DraftUUID=guid'00505691-115b-1ee6-b7af-2c76b881888d',IsActiveEntity=false)"
