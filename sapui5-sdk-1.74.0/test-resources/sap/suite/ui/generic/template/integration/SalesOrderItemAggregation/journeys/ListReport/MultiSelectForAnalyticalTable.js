	...
	function (opaTest, Opa5) {
		...
		QUnit.module("Sales Order Item Aggregation - MultiSelectForAnalyticalTable: Single Select", function (hooks) {
			...
			opaTest("Starting the app and loading data", function (Given, When, Then) {
				// arrangements
				Given.iStartTheListReport("manifestAnalyticalTable");
		...
		QUnit.module("Sales Order Item Aggregation - MultiSelectForAnalyticalTable: Multi Select", function (hooks) {

			opaTest("Starting the app and loading data", function (Given, When, Then) {
				// arrangements
				Given.iStartTheListReport("manifestAnalyticalTableMS");
		...
		QUnit.module("Sales Order Item Aggregation - MultiSelectForAnalyticalTable: Multi Select with Limit", function (hooks) {

			opaTest("Starting the app and loading data", function (Given, When, Then) {
				// arrangements
				Given.iStartTheListReport("manifestAnalyticalTableMSL");
