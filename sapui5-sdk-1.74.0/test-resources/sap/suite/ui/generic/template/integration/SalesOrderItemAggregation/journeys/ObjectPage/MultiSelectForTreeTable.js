	...
	function (opaTest, Opa5) {
		...
		QUnit.module("Sales Order Item Aggregation - MultiSelectForTreeTable: Single Select", function (hooks) {
			...
			opaTest("Starting the app (Object Page)", function (Given, When, Then) {
				// arrangements
				Given.iStartTheObjectPage("manifestTreeTable");
				// assertions
			...
			opaTest("Select one item and select another one", function (Given, When, Then) {
				...
				When.onTheGenericObjectPage
					.iSelectListItemsByLineNo([0], true, "to_ScheduleLine::com.sap.vocabularies.UI.v1.LineItem::treeTable")
					.and
					.iSelectListItemsByLineNo([1], true, "to_ScheduleLine::com.sap.vocabularies.UI.v1.LineItem::treeTable")
					.and
