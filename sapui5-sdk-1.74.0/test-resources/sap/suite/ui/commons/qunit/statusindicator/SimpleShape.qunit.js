sap.ui.define([
...
], function (jQuery, SimpleShape, SimpleShapeRenderer, FillingType, StubsFactory,
						 HtmlElement, Utils, sinon, sinon_qunit, createAndAppendDiv) {
	"use strict";
	...
	QUnit.test("Check usage of polygon mask", function (assert) {
		...
		assert.ok(jQuery.sap.endsWith(polygonElement.getAttribute("id"), "-polygon"));
