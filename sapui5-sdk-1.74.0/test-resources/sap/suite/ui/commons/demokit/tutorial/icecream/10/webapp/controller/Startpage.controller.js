sap.ui.define([
	...
	return Controller.extend("sap.suite.ui.commons.demokit.tutorial.icecream.10.controller.Startpage", {
		onInit: function () {
			var sDataPath = sap.ui.require.toUrl("sap/suite/ui/commons/demokit/tutorial/icecream/10/model/data") + "/News.json";
