...
sap.ui.define([
	...
	var oLandEntity = new LandscapeEntity({
		...
		id : "aminId",
		renderingSize : EntityCSSSize.Large,
		visible : true,
...
//	QUnit.test("CustomActionsCreationOk", function() {
...
//	});
	...
	oLandEntity.setRenderingSize(EntityCSSSize.Large);

	QUnit.test("CustomActionsCreationOk", function(assert) {
		var oDomRef = document.getElementById(oLandEntity.getId()+"restoreEntityAction-CLVEntityActionImg");
		assert.ok(oDomRef, "Restore icon exists");
