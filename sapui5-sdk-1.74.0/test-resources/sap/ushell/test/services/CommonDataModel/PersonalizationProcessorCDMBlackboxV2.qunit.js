...
sap.ui.require([
    ...
    var S_TEST_SITE_NAME_DEFAULT = "../../../cdmSiteData/CDMData4BlackboxTests.json",
        S_TEST_SITE_NAME_HCP = "../../../cdmSiteData/sampleHCPSitejson.json";
    ...
    module("sap.ushell.services.CommonDataModel.PersonalizationProcessor", {
        setup: function () {
            ...
            this.oLPA = new sap.ushell.adapters.cdm.LaunchPageAdapter(undefined, undefined, { config: {} });
