jQuery.sap.declare("ssuite.smartbusiness.tiles.lib.DualTileTimeStampControl");
sap.ui.define(["sap/m/TileContent", "sap/m/TileContentRenderer", "sap/ui/core/Control", "ssuite/smartbusiness/tiles/lib/Wrapper"],
		function(TileContent, Renderer, Control, Wrapper) {
			"use strict";

			var timestamp = Control.extend("Wrapper_Timestamp", {
				onclick : function(e) {
			...
			return Wrapper.extend("ssuite.smartbusiness.tiles.lib.DualTileTimeStampControl", {
				metadata : {
					properties : {
						timestamp : {
							type : "string"
